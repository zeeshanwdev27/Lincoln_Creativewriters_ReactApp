...
const dummyData = [
  {
    image: "/EditingService/Rewriting/rewriting-1.png",
    title: "Books and Manuscripts",
    description:
      "Transform your book or manuscript into a polished, professional work that captivates readers from the first page to the last.",
    features: [
      "Enhances clarity, style, and readability",
      "Refines grammar, punctuation, and flow",
      "Preserves your unique voice and tone",
    ],
  },
  {
    image: "/EditingService/Rewriting/rewriting-2.png",
    title: "Academic Papers And Speeches",
    description:
      "Elevate your academic papers and speeches with precise editing that strengthens arguments, improves structure, and ensures a compelling presentation.",
    features: [
      "Optimizes structure and logical flow",
      "Clarifies complex ideas effectively",
      "Enhances persuasive impact and readability",
    ],
  },
  {
    image: "/EditingService/Rewriting/rewriting-3.png",
    title: "Blogs And Articles",
    description:
      "Make your blogs and articles shine with professional editing that improves readability, engages your audience, and strengthens your message.",
    features: [
      "Polishes sentence structure and style",
      "Enhances word choice for impact",
      "Maintains consistent, engaging tone",
    ],
  },
  {
    image: "/EditingService/Rewriting/rewriting-4.png",
    title: "Website Content",
    description:
      "Ensure your website content is flawless, professional, and reader-friendly with meticulous proofreading and content refinement.",
    features: [
      "Corrects typos, grammar, and formatting",
      "Improves readability and flow",
      "Delivers polished, error-free content",
    ],
  },
];
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex flex-col gap-4 text-center mb-12 lg:mb-16">
        ...
        >
          ...
          Discover Premium Article Rewriting Services
        </motion.div>
        
        <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4">
        Types of Rewriting <br/> <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent ">Services We Offer</span>
        </h1>
...
export default RewritingContent;