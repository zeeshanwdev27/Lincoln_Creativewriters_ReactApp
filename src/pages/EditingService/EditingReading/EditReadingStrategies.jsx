...
import { Sparkles, CheckCircle, BriefcaseBusiness , Award    } from "lucide-react";
import { motion } from "framer-motion";

function EditReadingStrategies() {

  const cardsData = [
    {
      icon: <CheckCircle  className="w-8 h-8" />,
      title: "Error-Free Manuscript",
      description:
        "We have a team of professional writers possessing a wealth of knowledge and recognized abilities to write for all niches while holding on to values and high-quality standards.",
      color: "from-blue-500 to-cyan-500",
    },
    {
      icon: <Award   className="w-8 h-8" />,
      title: "Chances of Publication",
      description:
        "Wish to get your work published? Choose expert editors and proofreaders to increase the chances manifold.",
    ...
    },
    {
      ...
      description:
        "If you fail to reflect professionalism in your writing, you’ll fail to convey your message. With editing services, add that missing element of power!",
    ...
    <div className="flex flex-col items-center w-full mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 bg-[url(https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/gradientBackground.png)]">
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-7xl mx-auto">
        ...
        <p className="text-sm md:text-md lg:text-lg text-gray-600 max-w-5xl mx-auto">
         Choose the best editing services in town to attract, engage, and impress through your powerful content ideas. Channel the power of your content by giving it that finalized look that impresses the masses and wins hearts!
        </p>
      </div>
...
export default EditReadingStrategies;
