...
function EditingReadingProposals() {
...
const features = [
  {
    ...
    description:
      "At Lincoln Creative Writers, we believe every manuscript, even those written by the experts, needs to be given a second look. Some things are better left for the professionals, editing and proofreading being one of them!",
    offers: [
      "Addition of target audience-friendly verbiage",
      "Professional standard editing and proofreading",
    ],
    icon: UserCheck,
    color: "indigo",
  },
  {
    title: "Lock the Essence",
    description:
      "The best thing about our team of expert editors is that they never proofread a manuscript from their perspective. They understand your aspect and ensure their editing doesn’t impact a manuscript’s originality.",
    offers: [
      "Helping preserve the essence and theme",
      "Giving it a final touch without altering the storyline",
    ],
    icon: Lock,
    color: "indigo",
  },
  {
    title: "Keeping Up Promises",
    description:
      "We at Lincoln Creative Writers have established a solid reputation in the industry as we’re known for keeping up promises. From meeting deadlines to offering top-quality assistance, we always deliver what we promise.",
    offers: [
  ...
  },
  {
    ...
    description:
      "Have a deadline to meet? Don’t worry. We at Lincoln Creative Writers ensure that you get quality work within the promised deadline. Our experts give you realistic deadlines and are always true to their word.",
    offers: [
      "On-time deliveries always",
      "No rushed completion",
    ],
    icon: Clock,
    color: "indigo",
  },
...
export default EditingReadingProposals;
