...
function EditingReadingPackages() {
  const [activeTab, setActiveTab] = useState("basic");

  const packageData = {
    basic: [
      {
        package: "Short Documents",
        noOfArticles: `1 Page`,
        price: "250/page",
        perArticle: "$5",
      },
      {
        package: "Long Documents",
        noOfArticles: `6 Pages`,
        price: "250/page",
        perArticle: "$24",
      },
      {
        package: "Books",
        noOfArticles: `25 Pages`,
        price: "300/page",
        perArticle: "$75",
      },
    ],
  ...
  const tabs = [
    { id: "basic", label: "Professional Proofreading" },
    { id: "advance", label: "Professional Editing" },
  ];
      ...
      >
        ...
        >
          ...
          <div className="hidden md:flex bg-indigo-500 text-white font-semibold">
            ...
            <div className="flex-1 p-4 border-r border-indigo-400">Word Count</div>
                  ...
                  <div className="hidden md:flex">
                    ...
                    <div className="flex-1 p-4 border-r border-indigo-200 text-gray-700">
                      {data.perArticle === "Live Chat" ? (
                        ...
                        <span className="text-lg font-bold text-indigo-600">{data.perArticle}</span>
                      )}
                    </div>
...
export default EditingReadingPackages;