...
function EditingReadingContent() {
...
const dummyData = [
  {
    image: "/EditingService/EditingReading/Content/copyediting.png",
    title: "Copy Editing",
    description:
      "Professional copy editing that refines your manuscript for clarity, consistency, and correctness, ensuring your text communicates effectively.",
    features: [
  ...
  {
    image: "/EditingService/EditingReading/Content/developmentediting.png",
    title: "Development Editing",
    description:
      "In-depth developmental editing to enhance the structure, flow, and content of your manuscript, making your story or argument stronger and more engaging.",
    features: [
      "Improves structure and organization",
      "Strengthens plot, argument, or narrative",
      "Enhances overall readability and impact",
    ],
  },
  {
    image: "/EditingService/EditingReading/Content/lineediting.png",
    title: "Line Editing",
    description:
      "Detailed line editing that polishes sentence structure, word choice, and style, giving your writing a smooth, professional, and compelling voice.",
    features: [
      "Refines sentence flow and rhythm",
      "Enhances word choice and clarity",
      "Maintains consistent tone and style",
    ],
  },
  {
    image: "/EditingService/EditingReading/Content/proofreading.png",
    title: "Proofreading",
    description:
      "Meticulous proofreading to catch and correct any remaining errors in spelling, grammar, punctuation, and formatting before your manuscript is finalized.",
    features: [
      "Detects and corrects typos and errors",
      "Ensures correct formatting",
      "Provides a polished, error-free manuscript",
    ],
  },
];
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex flex-col gap-4 text-center mb-12 lg:mb-16">
        ...
        >
          ...
          Hire Professional Editors And Proofreaders Service
        </motion.div>
        
        <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4">
         Book Proofreading Services: <br/> <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent ">Diverse Range</span>
        </h1>
...
export default EditingReadingContent;