...
const HeroSection = () => {
  ...
  const userAvatars = [
    ...
    "https://images.unsplash.com/photo-1494790108755-2616b612b786?q=80&w=200",
    ...
    <div className="min-h-screen bg-linear-to-br from-white via-indigo-50/20 to-purple-50/10 pb-20 overflow-hidden relative">
      ...
      >
        ...
        {/* <motion.div
          ...
          className="flex flex-col sm:flex-row items-center gap-4 mt-20 sm:mt-24 bg-white/80 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-lg border border-white/20 max-w-md sm:max-w-lg mx-auto"
        >
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            ...
            <p className="text-sm text-gray-600 font-medium mt-1 flex items-center gap-1">
              ...
              Trusted by <span className="text-indigo-600 font-semibold">10,000+</span> creators
            </p>
          </div>
        </motion.div> */}
