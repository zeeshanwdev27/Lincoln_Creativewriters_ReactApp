...
function MakeADifference() {
  ...
  const features = [
    {
      title: "Keeping Eyes on Trends",
      description:
        "Our microbloggers keep a close eye on trends, resulting in content that stands out. We not only deliver exceptional content but also keep up with the trends.",
      offers: [
    ...
    },
    {
      title: "Quick Results",
      description:
        "We believe that microblogs should deliver quick results. Our experts leverage content to help you reach the digital marketing supremacy you deserve.",
      offers: [
        "Better understanding of the online world",
        "Creative and dedicated microblogging team",
        "Results based on modern market practices",
      ],
      icon: Search,
      color: "indigo",
    },
    {
      title: "Experts on the Job",
      description:
        "Our company has a team of professionals with content marketing experience to shine.",
      offers: [
        "Improved online footprint",
        "Groundbreaking trendy ideas",
        "A key to unlock the doors of personalization",
      ],
      icon: Target,
      color: "indigo",
    },
    {
      ...
      description:
        "We’re here to help you 24/7. Reach out to us at your convenience.",
      offers: [
        "100% tailored content",
        "On time deliveries",
        "Dedicated support",
      ],
      icon: Clock,
    ...
    <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-25 py-12 lg:py-15 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        >
          ...
          >
            Making a Difference Through Microblogging
          </motion.h1>
