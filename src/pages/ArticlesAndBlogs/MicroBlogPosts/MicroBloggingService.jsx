...
const dummyData = [
  {
    image: "/articles/microblog/linkedin.jpg",
    title: "LinkedIn",
    description:
      "Our LinkedIn microblogs help you establish professional authority and build meaningful business connections. Each post is optimized for engagement within professional circles, combining credibility with clear communication.",
    features: ["Professional Insights", "Authority Building", "B2B Engagement"]
  },
  {
    image: "/articles/microblog/twitter.jpg",
    title: "Twitter",
    description:
      "We craft concise and impactful Twitter microblogs that amplify your brand voice, spark conversations, and boost visibility through trending topics and hashtags. Perfect for keeping your audience informed and engaged.",
    features: ["Bite-Sized Content", "Hashtag Optimization", "Viral Reach"]
  },
  {
    image: "/articles/microblog/instagram.jpg",
    title: "Instagram",
    description:
      "Our Instagram microblogs pair visually stunning imagery with compelling captions to tell your brand’s story authentically. Every post is designed to capture attention, inspire emotion, and drive engagement.",
    features: ["Visual Storytelling", "Authentic Tone", "High Engagement"]
  },
  {
    image: "/articles/microblog/facebook.jpg",
    title: "Facebook",
    description:
      "We create engaging Facebook microblogs that foster community interaction and encourage sharing. Our content balances storytelling with brand messaging to keep your followers informed and emotionally connected.",
    features: ["Community Focused", "Shareable Posts", "Emotional Connection"]
  }
];
...
export default MicroBloggingService;