...
function LookingtoRevolutionize() {
  const [activeFeature, setActiveFeature] = useState(0);
  
  const features = [
    {
      title: "The Right Type of Marketing",
      description:
    ...
    {
      title: "Adding the Missing Piece to Your Puzzle",
      description:
    ...
    <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-25 py-12 lg:py-15 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        >
          ...
          >
            What Makes Us the Best Newsjacking Post Writing Services
          </motion.p>
...
export default LookingtoRevolutionize;