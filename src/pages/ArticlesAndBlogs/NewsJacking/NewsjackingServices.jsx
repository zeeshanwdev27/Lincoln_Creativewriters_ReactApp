...
const dummyData = [
  {
    image: "/articles/newsjacking/uniquecontent.jpg",
    title: "Unique Content",
    description:
      "We create original, news-aligned content that instantly captures audience attention. Every piece blends trending topics with your brand’s message to keep your content fresh, relevant, and share-worthy.",
    features: ["Trend Integration", "Creative Storytelling", "SEO Relevance"],
  },
  {
    image: "/articles/newsjacking/mediacoverage.jpg",
    title: "Media Coverage",
    description:
      "Our newsjacking techniques help your brand secure organic media attention. We align your content with breaking news and industry stories, positioning your brand as an expert source.",
    features: ["Press Visibility", "Authority Positioning", "Organic Outreach"],
  },
  {
    image: "/articles/newsjacking/publicexcitement.jpg",
    title: "Public Excitement",
    description:
      "We spark audience enthusiasm by connecting your brand with viral cultural moments. Each post is designed to create buzz, encourage shares, and elevate your visibility in real-time conversations.",
    features: ["Emotional Engagement", "Social Buzz", "Cultural Relevance"],
  },
  {
    image: "/articles/newsjacking/brandawarness.jpg",
    title: "Brand Awareness",
    description:
      "Our news-driven strategies help your brand stay top-of-mind by linking your messaging with trending events. This approach builds recognition, trust, and authority among your target audience.",
    features: ["Consistent Visibility", "Reputation Growth", "Trend-Based Positioning"],
  },
  {
    image: "/articles/newsjacking/realtime.jpg",
    title: "Real-Time Engagement",
    description:
      "We craft rapid-response content tailored to unfolding events. From trending hashtags to breaking news, our strategy ensures your brand enters the conversation at the perfect moment.",
    features: ["Instant Relevance", "Fast Content Production", "High Interaction Rate"],
  }
];
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex flex-col gap-4 text-center mb-12 lg:mb-16">
        ...
        <p className="text-slate-600 max-w-2xl mx-auto text-lg sm:text-xl leading-relaxed">
          How We Write Newsjacking Posts?
        </p>
      </motion.div>
...
export default NewsjackingServices;