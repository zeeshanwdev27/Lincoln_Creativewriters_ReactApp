  ...
  const features = [
    {
      ...
      description:
        "We take pride in calling ourselves the home to a talented team of writers who can produce premium quality listicles for you. Our writers come from distinguished backgrounds with successful track records. The listicles that we draft are driven by extensive research and thorough study.",
      offers: [
        "Customized listicles for every industry",
    ...
    },
    {
      ...
      description:
        "We believe there’s nothing that cannot be achieved with extensive research. This drives our skillful writers to study every project in-depth and provide engaging content that resonates with your needs and ideas. We produce reader-friendly content that can provide ample information to everyone across the board",
      offers: [
    ...
    {
      title: "Talented Team of Writers",
      description:
        "Our writers drive us to create content that is crafted according to your needs. We are a team of creators who understand the nitty gritties of each industry and can create highly competitive content for every niche. Our writers will help you at every step to ensure you get what you subscribe for.",
      offers: [
        "Years of experience",
        "Thorough understanding of niches",
    ...
    },
    {
      ...
      description:
        "Sometimes the final product may be in need of your final touch. This is why we offer unlimited revisions so we can guarantee your satisfaction. Our writers are dedicated to guiding you through the process so you can get what you paid for.",
      offers: [
    ...
    <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-25 py-12 lg:py-15 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          >
            Still Finding it Hard to Make a choice?
          </motion.p>
          ...
          >
            Here’s What Makes Us Best at What We Do
          </motion.h1>
