...
import { Sparkles, Info, AlignLeft, CheckCircle, FileText } from "lucide-react";
import { motion } from "framer-motion";

function HireListicleWritingExperts() {
  const cardsData = [
    {
      icon: <Info className="w-8 h-8" />,
      title: "Informative",
      description:
        "We at Lincoln Creative Writers are home to a dedicated writing force that produces informative and engaging listicles that can keep your readers informed without boring them.",
    ...
    },
    {
      ...
      title: "Concise",
      description:
        "We believe in keeping things short and simple with our unique writing style. Our professional writers know the art of providing quality content without complicating things.",
    ...
    },
    {
      ...
      title: "Accurate",
      description:
        "Our listicle writing service is built on the pillar of trust. That is why every project undergoes thorough research before making it to the readers.",
    ...
    },
    {
      ...
      title: "Content",
      description:
        "Our team’s attention to detail propels them to create original and 100% plagiarism-free content that resonates with the latest trends and popular demand.",
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-4xl mx-auto">
        ...
        >
          ...
          <span className="text-indigo-700 font-semibold text-sm">
            Hire Listicle Writing Experts Now
          </span>
        </motion.div>
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
          ...
          <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
            with Professional Listicle Writing
          </span>{" "}
        </h1>

        <p className="text-sm md:text-md lg:text-lg text-gray-600 max-w-2xl mx-auto">
         Our trained writing experts can produce engaging and high-quality listicles that are informative and concise, allowing your readers to grasp the context in no time.
        </p>
      </div>

      {/* Cards Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 sm:gap-8 w-full max-w-7xl">
...
export default HireListicleWritingExperts;
