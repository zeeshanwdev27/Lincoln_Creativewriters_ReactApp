...
function WhyOurMagazineArticle() {
  ...
  const features = [
    {
      ...
      description:
        "Our content writers work with a sales-focused strategy providing your magazine with credibility and quality. With our professional magazine articles, your publication will become popular among the masses resulting in improved sales.",
      offers: [
        "Region-oriented content ideas",
        "Personalized strategies for different industries",
    ...
    {
      title: "We Get Our Research Done",
      description:
        "We believe that the most salient feature of any type of content is its authenticity and intent. Our writers adopt a research-driven approach for every project. This enables them to curate content that resonates with the respective preferences of your audience.",
      offers: [
        "A comprehensive review of market trends",
        "Thorough study for different projects",
        "Content production ideas for future",
      ],
      icon: Search,
      color: "indigo",
    },
    {
      title: "Expert Writers for Every Topic",
      description:
        "Lincoln Creative Writers is a powerhouse that understands that content should align with your magazine's tone and theme. That’s why our professional team generates relatable and relevant content to help you create a powerful impact through your publication.",
      offers: [
        "Expert advice to boost magazine’s quality",
        "Content that connects with different demographics",
        "Customized writing styles for each industry",
      ],
      icon: Edit3,
      color: "indigo",
    },
    {
      ...
      description:
        "We understand that timely deliveries are all that matters when producing magazine articles. Lincoln Creative ensures timely deliveries of magazine articles by prioritizing efficient communication, clear expectations, and organized processes. This allows for effective collaboration between writers and editors, ensuring deadlines are met and the content is delivered on time to the readers.",
      offers: [
        "Dedicated support staff",
        "Unlimited content revisions",
        "Ability to curate tailored content",
      ],
      icon: Headphones,
      color: "indigo",
    },
  ...
  const buttonLabels = [
    ...
    "We Get Our Research Done",
    "Expert Writers for Every Topic",
    ...
    <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-25 py-12 lg:py-15 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          >
            Still Skeptical About Partnering with Us?
          </motion.p>
          ...
          >
            Here’s Why Our Article Writers Are Worth Every Penny
          </motion.h1>
...
export default WhyOurMagazineArticle;
