...
function PremiumMagazineContent() {
...
const dummyData = [
  {
    image: "/articles/Magazine/feature-article.jpg",
    title: "Feature Article",
    description:
      "In-depth, narrative-driven stories that explore a subject from multiple angles. Our feature articles combine strong research, compelling storytelling, and polished writing to keep readers engaged from start to finish.",
    features: ["Detailed Research", "Engaging Storytelling", "Reader Retention"]
  },
  {
    image: "/articles/Magazine/Informative-article.jpg",
    title: "Informative Article",
    description:
      "Clear, factual, and well-structured content that educates readers on specific topics. These articles break down complex information into accessible insights while maintaining authority and accuracy.",
    features: ["Educational Tone", "Clarity & Accuracy", "Expert Insights"]
  },
  {
    image: "/articles/Magazine/opinion-article.jpg",
    title: "Opinion Article",
    description:
      "Bold and thought-provoking pieces that express a clear viewpoint. Our opinion articles are designed to inspire discussion, challenge perspectives, and position your magazine as a voice of authority.",
    features: ["Persuasive Writing", "Strong Perspective", "Audience Engagement"]
  },
  {
    image: "/articles/Magazine/technical-article.jpg",
    title: "Technical Article",
    description:
      "Comprehensive and well-researched articles tailored for professional or niche audiences. Our technical content simplifies complex concepts without losing precision, ensuring clarity for both experts and newcomers.",
    features: ["Data-Driven Content", "Clarity in Complexity", "Industry Expertise"]
  }
];
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex flex-col gap-4 text-center mb-12 lg:mb-16">
        ...
        >
          ...
          Hire Professional Magazine Article Writers Today
        </motion.div>
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-4">
         Premium Content Tailored for Your Magazine
        </h1>
        
        <p className="text-slate-600 max-w-2xl mx-auto text-lg sm:text-xl leading-relaxed">
          Custom Premium Content Perfectly in Tune with Your Magazine
        </p>
      </motion.div>
...
export default PremiumMagazineContent;