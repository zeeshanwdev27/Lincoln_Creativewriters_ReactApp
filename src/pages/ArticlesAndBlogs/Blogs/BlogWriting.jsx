...
function BlogWriting() {
  return (
    ...
    <ArticleWriting title1={'Premium'} title2={'Blog'} title3={'Writing'} title4={'Services For Everyone'} description={"Our expert blog post writers excel in maintaining the audience's interest with unique writing styles."} amount={"10"}/>
