...
function HireProfessionalBlogWriter() {
  ...
  const cardsData = [
    ...
    },
    {
      ...
      title: "Build Your Brand's Identity",
      description:
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-4xl mx-auto">
        ...
        >
          ...
          <span className="text-indigo-700 font-semibold text-sm">
           Hire Professional Blogs Writing Service
          </span>
        </motion.div>
        ...
        <p className="text-sm md:text-md lg:text-lg text-gray-600 max-w-2xl mx-auto">
          Blogs are a great source to build a prominent presence online. They also help in improving the visual appeal of your homepage. Our writers ensure that the blogs are goal-driven and have the correct keyword placement for better results.
        </p>
      </div>
...
export default HireProfessionalBlogWriter;
