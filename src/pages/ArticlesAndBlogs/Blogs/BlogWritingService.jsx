...
function BlogWritingService() {
  ...
  const dummyData = [
  {
    image: "/articles/blog/business-blog.jpg",
    title: "Business Blogs",
    description:
      "Our business blogs deliver insightful strategies, market trends, and expert advice to help professionals and organizations stay competitive. Each post is crafted with a professional tone to enhance credibility and authority.",
    features: ["Data-Driven Insights", "Professional Tone", "Thought Leadership"]
  },
  {
    image: "/articles/blog/guest-blog.jpg",
    title: "Guest Blogs",
    description:
      "Guest blogs help brands build relationships, reach new audiences, and improve domain authority. We craft high-quality posts tailored to the host site's niche and tone, ensuring seamless integration and reader engagement.",
    features: ["Backlink Growth", "Audience Expansion", "Niche Relevance"]
  },
  {
    image: "/articles/blog/lifestyle-blog.jpg",
    title: "Lifestyle Blogs",
    description:
      "Our lifestyle blogs inspire readers with relatable content about wellness, travel, fashion, food, and everyday living. Each post is written in a conversational, authentic style that connects emotionally with your audience.",
    features: ["Relatable Tone", "Visually Engaging", "Trend-Focused"]
  },
  {
    image: "/articles/blog/marketing-blog.jpg",
    title: "Marketing Blogs",
    description:
      "Marketing blogs designed to educate and convert — covering topics like branding, SEO, digital campaigns, and content strategy. Every piece is optimized to position your brand as an authority in the marketing world.",
    features: ["SEO Optimized", "Brand Awareness", "Lead Generation Focused"]
  },
  {
    image: "/articles/blog/news-blog.jpg",
    title: "News Blogs",
    description:
      "Our news blogs provide up-to-date coverage and sharp analysis on trending topics. Written with accuracy and urgency, they keep your readers informed and engaged with credible, fact-checked reporting.",
    features: ["Timely Updates", "Fact-Checked", "Engaging Headlines"]
  }
];
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex flex-col gap-4 text-center mb-12 lg:mb-16">
        ...
        <p className="text-slate-600 max-w-2xl mx-auto text-lg sm:text-xl leading-relaxed">
          Hire Professional blog writing services tailored to your specific needs and audience
        </p>
      </motion.div>
