...
function ProminentFeatures() {
  const [activeFeature, setActiveFeature] = useState(0);
  
  const features = [
    {
      title: "Goal Driven Keywords",
      description:
        "We know which keywords are effective to make your content reachable to the audience. Our team of professional writers carefully place each keyword based on its effectiveness and popularity.",
      offers: [
        "Extensive research",
        "Realistic approach",
        "Precise analytics",
    ...
    {
      title: "Simplifying the Content",
      description:
        "Writing blogs isn't always about putting out content. Readability plays a key role in making the content attractive to the readers. Our writers simplify the content for the readers.",
      offers: [
        "Practical approach",
        "User friendly",
    ...
    },
    {
      ...
      description:
        "Our content writers make sure to research each topic thoroughly before writing about it. We believe in sourcing information only from credible means to provide readers with authentic content.",
      offers: [
    ...
    },
    {
      ...
      description:
        "Plagiarism is against our work ethics, and we ensure that our content is 100% unique. Originality makes the content stands out, and our writers ensure to maintain it for you.",
      offers: [
        "Fact-checking",
        "Fact-checking",
        "Seasoned writers",
    ...
    <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-25 py-12 lg:py-15 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        >
          ...
          >
            Prominent Features of Our Services
          </motion.h1>
