...
function DistinctiveFeatures() {
  const [activeFeature, setActiveFeature] = useState(0);
  
  const features = [
    {
      title: "The Credibility Matters!",
      description:
        "The credibility of the content makes all the difference. Our writers ensure that the content they produce for you is 100% plagiarism-free to maintain the authenticity of your business.",
      offers: [
        "Authentic sources",
        "24/7 support",
        "Experienced writers",
    ...
    {
      title: "Delivering Authentic Content",
      description:
        "We have well-informed content writers that thoroughly research the subject before starting a new project. Our motive is to provide original content that can help you reach your goals.",
      offers: [
    ...
    },
    {
      ...
      description:
        "We as content writing professionals, understand that each business has different content requirements. Our expert writers closely study the requirements of each project in detail before curating the content.",
      offers: [
        "Detailed research",
        "Dedicated writers",
        "Expert consultation",
    ...
    {
      title: "Following the Demands",
      description:
        "Our team adds value to the projects through their unique writing styles. We understand that each writing project is different; hence our writers are capable of adapting different styles",
      offers: [
        "Project study",
        "Specialized writers",
        "Adaptive approach",
  ...
  const offerIcons = [CheckCircle, FileText, Users, Lightbulb, BarChart3, Clock, Award, Zap];
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        >
                          <IconComponent 
                            size={24} 
                            className={activeFeature === index ? "text-white" : "text-indigo-600"}
                          />
                        </motion.div>
                          ...
                          return (
                            ...
                            >
                              <div className="p-2 bg-indigo-100 rounded-lg group-hover:bg-indigo-200 transition-colors duration-300">
                                <OfferIcon className="text-indigo-600" size={20} />
                              </div>
