...
function Article() {
  return (
    ...
    <ArticleWriting title1={'Premium'} title2={'Article'} title3={'Writing'} title4={'Services'} description={"Hire article writers who can provide you with results helping you boost your business."} amount={"10"}/>
    <HireExpert/>
