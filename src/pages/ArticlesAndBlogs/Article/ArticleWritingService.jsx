...
function ArticleWritingService() {
  ...
  const dummyData = [
    {
      image:
        "/articles/linkedin.jpg",
      title: "LinkedIn Articles",
      description:
        "The competition in the corporate world is getting tougher every day. LinkedIn articles can be the master plan that can help you build authority. We have trained writers to meet your goals on the LinkedIn platform.",
      features: ["Authority Building", "Professional Tone", "SEO Optimized"]
    },
    {
      image:
        "/articles/industry.jpg",
      title: "Industry Articles",
      description:
        "Each industry has its unique nuisances, and they must reflect in each article written for the industry. Our writers ensure to research each topic thoroughly to provide information based on facts utilizing authentic resources.",
      features: ["Industry Research", "Fact-Based", "Authentic Resources"]
    },
    {
      image:
        "/articles/news.jpg",
      title: "News Articles",
      description:
        "News articles are a great way to break the hottest news to your readers. Our professional writers ensure that each news article has enough substance in it to make the news engaging for the readers.",
      features: ["Timely Delivery", "Engaging Content", "Fact-Checked"]
    },
    {
      image:
        "/articles/magazine.jpg",
      title: "Magazine Articles",
      description:
        "Magazine articles need to be brief and appealing. What most writers forget is to match the tone and style of the magazine. We ensure that the articles incorporate the tone and the targeted audience.",
      features: ["Visual Appeal", "Targeted Audience", "Brand Alignment"]
    },
  ];
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex flex-col gap-4 text-center mb-12 lg:mb-16">
        ...
        <p className="text-slate-600 max-w-2xl mx-auto text-lg sm:text-xl leading-relaxed">
          Hire Professional article writing services tailored to your specific needs and audience
        </p>
      </motion.div>
