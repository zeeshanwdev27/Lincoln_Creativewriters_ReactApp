...
import { Shield, Sparkles, Network, ChartNoAxesCombined } from "lucide-react";
import { motion } from "framer-motion";

function PowerYourMarketing() {
  const cardsData = [
    {
      icon: <Shield className="w-8 h-8" />,
      title: "A Strong Presence",
      description:
        "Our expert writers ensure that your power blogs pack enough punch to help you improve your organic reach.",
      color: "from-blue-500 to-cyan-500",
    },
    {
      icon: <ChartNoAxesCombined className="w-8 h-8" />,
      title: "SEO-Driven Posts",
      description:
        "SEO is an essential part of any content strategy. That's why our power blogs are curated with end to end compliance with SEO-based practices.",
    ...
    },
    {
      ...
      title: "More Shares",
      description:
        "Our long-form content continues to be so well-researched and data-driven that it will increase your shares manifold.",
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-4xl mx-auto">
        ...
        >
          ...
          <span className="text-indigo-700 font-semibold text-sm">
            Our Power Bloggers Deliver The Best
          </span>
        </motion.div>
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
          ...
          <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
            With Lincoln Creative
          </span>{" "}
          <span>Writers</span>
        </h1>

        <p className="text-sm md:text-md lg:text-lg text-gray-600 max-w-2xl mx-auto">
          Well-detailed content is crucial to help you stand out in the crowd.
          This is one of the reasons why our power blog writers craft witty and
          engaging power blogs to improve your organic reach.
        </p>
      </div>
...
export default PowerYourMarketing;
