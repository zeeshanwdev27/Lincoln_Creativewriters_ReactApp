...
function WhyChoosePowerPostBlog() {
  ...
  const features = [
    {
      ...
      description:
        "We have some of the finest power bloggers in the country. Here’s how we’re different",
      offers: [
        "Experienced writers who belong to different niches.",
        "They keep up with the trends to give you the best chance at success.",
      ],
      icon: UserCheck,
      color: "indigo",
    },
    {
      ...
      description:
        "Although power blogs are lengthy pieces of content, our experts ensure to deliver everything on time",
      offers: [
        "We ensure that our power blogs are delivered on time to ensure that your marketing efforts stay intact.",
        "Our writers also handle revisions with zero delays.",
      ],
      icon: Zap,
      color: "indigo",
    },
    {
      ...
      description:
        "Editing power blogs can be a hassle in itself. Not for us, though, because our editors have the knowledge and the experience to deliver perfection.",
      offers: [
        "An editing team will be assigned to work with you.",
        "Your brand’s vision will be kept intact by our editors.",
      ],
      icon: Edit3,
      color: "indigo",
    },
    {
      ...
      description:
        "We will assign dedicated project managers to your project, who will also communicate with you throughout the tenure.",
      offers: [
        "A project manager will be assigned to your project, who will look after it for the entire tenure.",
        "Project managers will also keep track of how your power blogs are performing and keep you in the loop.",
      ],
      icon: UserPlus,
      color: "indigo",
    },
    ...
    <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-25 py-12 lg:py-15 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          >
            Why Choose Our Power Post Blog Writing Services.
          </motion.p>
          ...
          >
            Take Your Content Marketing to New Heights with Lincoln Creative
            Writers
          </motion.h1>
...
export default WhyChoosePowerPostBlog;
