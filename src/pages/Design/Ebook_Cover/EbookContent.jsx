...
const dummyData = [
  {
    image: "/Design/Ebook/content1.png",
    title: "Fiction",
    description:
      "Engaging fiction eBooks crafted to captivate readers with immersive stories, memorable characters, and compelling plots.",
    features: [
      "Rich storytelling with well-developed characters",
      "Creative and imaginative plotlines",
      "Designed to engage and entertain readers from start to finish",
    ],
  },
  {
    image: "/Design/Ebook/content2.png",
    title: "Non-Fiction",
    description:
      "Informative non-fiction eBooks that provide valuable insights, actionable knowledge, and factual content for readers.",
    features: [
      "Well-researched and fact-checked content",
      "Clear structure and logical flow",
      "Ideal for educational, professional, or self-help topics",
    ],
  },
  {
    image: "/Design/Ebook/content3.png",
    title: "Autobiography",
    description:
      "Personalized autobiographies that narrate life stories with authenticity, capturing unique experiences and perspectives.",
    features: [
      "Highlights significant life events and achievements",
      "Authentic and engaging storytelling style",
      "Structured to create a compelling narrative journey",
    ],
  },
  {
    image: "/Design/Ebook/content4.png",
    title: "Children's Book",
    description:
      "Vibrant and imaginative children's eBooks designed to entertain, educate, and inspire young readers with fun stories and visuals.",
    features: [
      "Colorful illustrations and playful designs",
      "Simple and age-appropriate language",
      "Stories that teach lessons while keeping children engaged",
    ],
  },
];
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex flex-col gap-4 text-center mb-12 lg:mb-16">
        ...
        >
          ...
          Hire Book Cover Designers
        </motion.div>
        
        <h1 className="text-4xl sm:text-4xl lg:text-5xl xl:text-5xl font-bold mb-4">
         <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent ">Lucrative Ebook Designs for All </span>
        </h1>
