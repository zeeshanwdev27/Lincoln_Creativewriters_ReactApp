...
function EbookProposals() {
  const [activeFeature, setActiveFeature] = useState(0);

const features = [
  {
    title: "Designs Like No Other",
    description:
  ...
  {
    title: "Award Winning Ebook Designers",
    description:
    ...
    <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-25 py-12 lg:py-15 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          >
            Still Wondering Why Should You Hire Us?
          </motion.p>
          ...
          >
          This is What Makes Us Stand Apart
          </motion.h1>
                    <motion.div
