...
const EbookStrategies  = React.lazy(()=> import('./EbookStrategies.jsx'))
const EbookContent  = React.lazy(()=> import('./EbookContent.jsx'))
const EbookProposals  = React.lazy(()=> import('./EbookProposals.jsx'))



function Ebook_Cover() {
  return (
    <>
        <Suspense fallback={ <div className="flex items-center justify-center mt-80"> <div className="w-12 h-12 border-4 border-indigo-500 border-t-transparent rounded-full animate-spin"></div></div>}>
        
        <MBHeroSection title1={"Professional"} title2={""} title3={"EBook"} title4={"Cover Design Service"} description={"Our expert eBook designers can help you design an aesthetic book cover that matches the tone of your book."}/>
        <EbookStrategies/>
