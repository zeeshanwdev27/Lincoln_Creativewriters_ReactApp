...
function LetterProposals() {
  const [activeFeature, setActiveFeature] = useState(0);

const features = [
  {
    title: "Business Focus Approach",
    description:
      "We believe that letterheads are useful for businesses in more than one way. That makes our writers and designers opt for a business-centric approach helping businesses create a narrative that benefits them in the long run.",
    offers: [
      "Strategic consultancy and support",
      "Original letterhead templates",
  ...
  },
  {
    ...
    description:
      "We at Lincoln Creative Writers stay on the mark to facilitate our clients with professional support. We are determined to guide you throughout the process.",
    offers: [
      "Timely deliveries",
  ...
  },
  {
    ...
    description:
      "Didn’t like the results? No problem. We offer unlimited revisions to help you find the perfect results without any hassle. Our letterhead designers will do all it takes to provide you with a letterhead representing your ideas.",
    offers: [
      "An expert team of designers",
      "Complete walk-through of the creative process",
      "Niche-based letterheads",
  ...
  {
    title: "Fully Personalized Templates",
    description:
    ...
    <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-25 py-12 lg:py-15 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          >
            Wondering Why Choose Our Letterhead Services?
          </motion.p>
          ...
          >
          Experience Our Premium Letterhead Design Service Today
          </motion.h1>
                    <motion.div
...
export default LetterProposals;
