...
const dummyData = [
  {
    image: "/Design/LetterHead/content1.png",
    title: "Educational Letterhead",
    description:
      "Professional educational letterheads designed to reflect academic institutions’ identity while providing clear, structured information.",
    features: [
      "Incorporates school or university branding elements",
      "Organized layout for easy readability",
      "Ideal for official correspondence and academic documents",
    ],
  },
  {
    image: "/Design/LetterHead/content2.png",
    title: "Real Estate Letterhead",
    description:
      "Clean and professional letterheads tailored for real estate professionals, enhancing credibility and reinforcing brand identity.",
    features: [
      "Highlights agency logo and contact information",
      "Elegant layout suitable for property listings and communications",
      "Supports both formal and promotional use",
    ],
  },
  {
    image: "/Design/LetterHead/content3.png",
    title: "Photography Letterhead",
    description:
      "Creative letterheads for photographers that showcase their brand and style while maintaining professionalism for client communications.",
    features: [
      "Visually appealing design reflecting photography style",
      "Ample space for client details and messaging",
      "Perfect for contracts, invoices, and client letters",
    ],
  },
  {
    image: "/Design/LetterHead/content4.png",
    title: "Business Letterhead",
    description:
      "Corporate letterheads designed to communicate professionalism, build trust, and reinforce brand identity in all business correspondence.",
    features: [
      "Clean, professional layouts suitable for all corporate communications",
      "Brand elements like logo and color scheme prominently featured",
      "Ideal for contracts, invoices, and official letters",
    ],
  },
];
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex flex-col gap-4 text-center mb-12 lg:mb-16">
        ...
        >
          ...
          Get Professional Letterhead Designers On Board
        </motion.div>
        
        <h1 className="text-4xl sm:text-4xl lg:text-5xl xl:text-5xl font-bold mb-4">
         <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent ">Professional Letterheads for Every Business </span>
        </h1>
