...
const dummyData = [
  {
    image: "/Design/Infographic/content1.png",
    title: "Appealing Content For Infographic",
    description:
      "Eye-catching infographic content designed to simplify complex information and present it in a visually engaging way.",
    features: [
      "Clear and concise information breakdown",
      "Visually attractive layouts for better engagement",
      "Enhanced readability with creative design elements",
    ],
  },
  {
    image: "/Design/Infographic/content2.png",
    title: "Resume Content For Infographic",
    description:
      "Professionally structured infographic resumes that highlight your skills, experience, and achievements with visual clarity.",
    features: [
      "Skill-focused visual representation",
      "Structured layout for easy scanning",
      "Modern design that enhances professional appeal",
    ],
  },
  {
    image: "/Design/Infographic/content3.png",
    title: "Hierarchical Content For Infographic",
    description:
      "Infographics built with a clear hierarchy to guide viewers through information step-by-step for maximum understanding.",
    features: [
      "Logical flow from top-level to detailed points",
      "Emphasis on key information at a glance",
      "Organized design that boosts viewer comprehension",
    ],
  },
];
    ...
    >
      ...
      >
        ...
        >
         ...
         Hire Professional Infographics Design Service
        </motion.div>
