...
import { Sparkles, BarChart3, Megaphone , TrendingUp    } from "lucide-react";
import { motion } from "framer-motion";

function InfographicStrategies() {

  const cardsData = [
    {
      icon: <BarChart3 className="w-8 h-8" />,
      title: "Best Infographics In The Region",
      description:
        "We're one of the best infographics creators in the region. Benefit from services that enhance your brand's image.",
      color: "from-blue-500 to-cyan-500",
    },
    {
      icon: <Megaphone  className="w-8 h-8" />,
      title: "Persuade your Target Audience",
      description:
        "At Lincoln Creative Writers, we craft well-researched content that entices your target audience to take the desired action.",
      color: "from-green-500 to-emerald-500",
    },
    {
      icon: <TrendingUp className="w-8 h-8" />,
      title: "Helping You to Give your Brand a Visual Lift",
      description:
        "Your brand will get the visual lift it deserves with our detailed and well-researched infographics content and appealing designs.",
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-5xl mx-auto">
        ...
        >
          ...
          <span className="text-indigo-700 font-semibold text-sm">
           Hire Professional Infographics Designers
          </span>
        </motion.div>
        ...
        <p className="text-sm md:text-md lg:text-lg text-gray-600 max-w-5xl mx-auto">
         A picture is indeed worth a thousand words, but not in marketing. When creating your infographics, always adopt a design combined with content that suits your business needs. Not sure how to do it? Hire professionals for informative and attractive infographics.
        </p>
      </div>
...
export default InfographicStrategies;
