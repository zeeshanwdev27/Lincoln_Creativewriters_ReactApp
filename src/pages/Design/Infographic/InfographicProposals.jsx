...
const features = [
  {
    title: "Great Designs",
    description:
      "At Lincoln Creative Writers, we create visually powerful infographic designs that blend text and graphics seamlessly to boost retention, clarity, and overall impact.",
    offers: [
      "Designs aligned with your brand’s message and identity",
      "Thoughtfully selected colors, icons, and visuals for stronger appeal",
    ],
    icon: Palette,
    color: "indigo",
  },
  {
    title: "Social Media Linkage",
    description:
      "Our infographics are built to perform on social media—easy to share, engaging to view, and effective in driving users directly to your platforms.",
    offers: [
      "Share-worthy designs that increase social reach",
      "Created to naturally attract and guide your target audience",
    ],
    icon: Share2,
    color: "indigo",
  },
  {
    ...
    description:
      "We enhance your infographics by converting them into engaging video formats. Our animators bring each element to life, ensuring maximum interaction and retention.",
    offers: [
      "Animations crafted to highlight key information",
      "Video formats optimized for higher engagement across platforms",
    ],
    icon: Video,
    color: "indigo",
  },
  {
    title: "Our Results-driven Efforts",
    description:
      "Our infographics consistently deliver results by transforming complex content into visually appealing, easy-to-digest information that keeps viewers engaged.",
    offers: [
      "Creative storytelling backed by strong visual presentation",
      "End-to-end execution—from concept development to final delivery",
    ],
    icon: BarChart3,
    color: "indigo",
  },
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
         ...
         Here are just a few reasons why you should work with us.
          ...
          >
          Why choose infographic design agency?
          </motion.h1>
                    <motion.div
...
export default InfographicProposals;
