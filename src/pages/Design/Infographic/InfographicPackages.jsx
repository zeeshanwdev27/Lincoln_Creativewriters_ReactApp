...
function InfographicPackages() {
  ...
  const packageData = {
    basic: [
      {
        package: "Bronze",
        noOfArticles: `10 Custom Infographics`,
        price: "$1350",
        perArticle: "$135",
      },
      {
        package: "Silver",
        noOfArticles: `20 Custom Infographics`,
        price: "$2500",
        perArticle: "$125",
      },
      {
        package: "Gold",
        noOfArticles: `40 Custom Infographics`,
        price: "$4400",
        perArticle: "$110",
      },
    ]
      ...
      >
        ...
        >
          ...
          <div className="hidden md:flex bg-indigo-500 text-white font-semibold">
            ...
            <div className="flex-1 p-4 border-r border-indigo-400">No. of Infographics</div>
            <div className="flex-1 p-4 border-r border-indigo-400">Price</div>
            <div className="flex-1 p-4 border-r border-indigo-400">Per Infographic</div>
...
export default InfographicPackages;