...
const features = [
  {
    ...
    description:
      "We continue to attract clients because our satisfied clients have spoken about the results we produced. We ensure that both your designs and the flyer's content are the highlight of your branding strategy.",
    offers: [
      "Outstanding services",
      "Satisfaction guaranteed in design, content, and customer service",
      "We have designers, especially for flyers",
      "Content marketers who know what they are doing.",
    ],
    icon: BadgeCheck,
    color: "indigo",
  },
  {
    ...
    description:
      "The best part about working with Lincoln Creative Writers is that we offer our clients designated project managers who will lead their projects from inception to completion.",
    offers: [
      "Acting as the mediator between you and our team",
      "The project manager will ensure that the end product is just as you dreamed for",
      "The project manager will stay in touch with you throughout the tenure.",
    ],
    icon: ListChecks,
    color: "indigo",
  },
  {
    ...
    description:
      "We offer our clients 24/7 customer service. So, whatever concern or query you have, our representative will answer them for you.",
    offers: [
      "24/7 customer service",
      "We guarantee urgent revisions",
    ],
    icon: Headset,
    color: "indigo",
  },
  {
    ...
    description:
      "At Lincoln Creative Writers, we have industry experts working in our ranks. So, rest assured, your flyer project is in great hands.",
    offers: [
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
         ...
         Here are just a few reasons why you should work with us.
          ...
          >
          Result-oriented flyer content writing
          </motion.h1>
                    <motion.div
