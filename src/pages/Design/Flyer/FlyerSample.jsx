...
function FlyerSample() {
  const cardsData = [
    { title: "Flyer Sample 1", image: "/Design/Flyer/Sample/sample1.png", pdfLink : '/Design/Flyer/Sample/preview1.png', },
    { title: "Flyer Sample 2", image: "/Design/Flyer/Sample/sample2.png", pdfLink : '/Design/Flyer/Sample/sample2.pdf'},
    { title: "Flyer Sample 3", image: "/Design/Flyer/Sample/sample3.png", pdfLink : '/Design/Flyer/Sample/sample3.pdf'},
  ];
    ...
    >
      ...
      <div className="relative z-10 w-full flex flex-col items-center max-w-8xl h-full justify-center">
        ...
        >
          ...
          >
            Explore Our Diverse Content Writing{" "}
          ...
          >
            We deliver premium quality technical writing services to our clients
          </motion.p>
        </motion.div>
