  ...
  const cardsData = [
    {
      ...
      description:
        "The design of a flyer is crucial for making an exciting first impression. The designers at Lincoln Creative Writers will align your skills and abilities with the flyers to attract the employer's attention – then the content does the rest of the job.",
    ...
    },
    {
      ...
      description:
        "The content we write for your resume does not merely reflect your skills and experience but is molded to accommodate market requirements. At Lincoln Creative Writers, we deliver concise yet powerful content to meet employers' demands.",
    ...
    },
    {
      ...
      description:
        "Don't like the content? We offer unlimited revisions, both on the design and content forefront. What are you waiting for? Call us now! We will keep serving you till you are completely satisfied.",
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-5xl mx-auto">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-gray-900 mb-5">
          ...
          <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
           Flyers that guarantee results
          </span>{" "}
        </h1>

        <p className="text-sm md:text-md lg:text-lg text-gray-600 max-w-5xl mx-auto">
            At Lincoln Creative Writers, we offer our clients professionally written and designed flyers that attract the employer's attention. We understand that professional flyers can make a great first impression and this is exactly why we work hard to impress.
        </p>
      </div>
...
export default FlyerStrategies;
