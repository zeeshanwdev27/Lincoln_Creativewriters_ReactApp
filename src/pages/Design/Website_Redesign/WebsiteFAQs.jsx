...
function WebsiteFAQs() {
   const [openIndex, setOpenIndex] = React.useState(null);
    ...
    const faqs = [
        {
            question: "What types of website redesign services do you offer?",
            answer: "We provide a full suite of redesign services, including branding updates, UX design, custom development, content migration, and ongoing support. Our solutions can range from complete ground-up rebuilds to targeted enhancements of existing sites.",
        },
        {
            question: "How can a small business benefit from a website redesign?",
            answer: "A redesign keeps your website modern, mobile-optimized, and conversions-focused. It can boost credibility and increase traffic and sales. Our affordable packages are tailored specifically for small businesses and startups.",
        },
        {
            question: "What is your design and development process?",
            answer: "Our process involves initial strategy calls, content audits, design mockups, development, testing, training, and launch support. Clients are involved in every step to ensure the final product matches their brand and goals.",
        },
        {
            question: "How long does the average redesign take?",
            answer: "Most basic to intermediate redesign projects are completed within 8-12 weeks. More extensive rebuilds may take 12-16 weeks. We provide estimated timelines customized to the specific scope of work.",
        },
        {
            question: "What is your approach to UX design?",
            answer: "User experience is our top priority. We conduct user testing and analytics reviews to understand pain points. Personas and journey maps then inform intuitive interfaces optimized for usability, engagement, and conversions.",
        },
        {
            question: "How do you measure the success of a website redesign project?",
            answer: "We use a mix of key performance indicators (KPIs) and analytics tools to monitor the effects of the redesign. Our reports show the concrete benefits of our services, including increased traffic and engagement, higher conversion rates, and improved search engine rankings. Our goal is to ensure that your investment in a website redesign yields measurable results and drives tangible business growth.",
        },
    ];
