...
const features = [
  {
    title: "Unique and Iconic Designs",
    description:
      "We understand that business card designs can significantly impact your business profile. We offer iconic and trendy business card options that resonate with your vision and goals.",
    offers: [
      "Countless design templates",
  ...
  {
    title: "Business-Centric Designs",
    description:
      "Business cards play a key role in sending a strong perception about an enterprise. Our business card experts produce premium and persuasive content that helps your business thrive in multiple ways.",
    offers: [
      "100% plagiarism-free content",
      "Tailored content that resonates with your business",
      "Skilled writers who understand your needs",
    ],
    icon: Briefcase,
    color: "indigo",
  },
  {
    title: "Niche-Based Approach",
    description:
      "We understand that every business has unique demands. This makes us take a pragmatic approach that connects with your imagination. We guarantee results that can have a positive impact on your business",
    offers: [
  ...
  },
  {
    ...
    description:
      "In our books, customizability can make all the difference for a thriving business. This is why our expert business card designers enable you to add a unique touch of personalization to every card.",
    offers: [
      "Vibrant and trendy design options",
      "Around-the-clock support",
      "Original and niche-centric content",
    ],
    icon: Sliders,
    color: "indigo",
  },
