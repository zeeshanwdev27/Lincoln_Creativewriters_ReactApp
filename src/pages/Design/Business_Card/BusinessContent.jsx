...
const dummyData = [
  {
    image: "/Design/BusinessCard/content1.png",
    title: "Customized Business Cards",
    description:
      "Tailor-made business cards designed to reflect your brand’s identity and leave a lasting impression on clients and partners.",
    features: [
      "Fully personalized design and layout",
      "Incorporates brand colors, logo, and style",
      "Leaves a memorable impression on recipients",
    ],
  },
  {
    image: "/Design/BusinessCard/content2.png",
    title: "Standard Business Cards",
    description:
      "Classic business cards with clean design and essential contact information, perfect for professional networking and day-to-day use.",
    features: [
      "Professional, easy-to-read layout",
      "Focus on essential details and clarity",
      "Suitable for any business or industry",
    ],
  },
  {
    image: "/Design/BusinessCard/content3.png",
    title: "Squared Business Cards",
    description:
      "Modern square-shaped business cards that stand out with a unique format while maintaining professionalism and clarity.",
    features: [
      "Distinctive square shape for visual appeal",
    ...
    >
      ...
      >
        ...
        >
         ...
         Hire Expert Business Card Designers Today
        </motion.div>
        ...
        <h1 className="text-4xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-4">
          Unique Business Designs That Match Your Vision
        </h1>
      </motion.div>
