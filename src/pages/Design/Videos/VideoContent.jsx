...
const dummyData = [
  {
    image: "/Design/Video/content1.png",
    title: "Brand Content Videos",
    description:
  ...
  {
    image: "/Design/Video/content2.png",
  ...
  {
    image: "/Design/Video/content3.png",
  ...
  {
    image: "/Design/Video/content4.png",
    ...
    {
    image: "/Design/Video/content5.png",
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex flex-col gap-4 text-center mb-12 lg:mb-16">
        ...
        >
          ...
          Unleash Your Potential with Our Video Services
        </motion.div>
        
        <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-6xl font-bold mb-4">
         Our Most In-Demand <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent ">Video Offerings </span>
        </h1>
