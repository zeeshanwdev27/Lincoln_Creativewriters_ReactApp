...
function TranscriptionProposal() {
  const [activeFeature, setActiveFeature] = useState(0);

const features = [
  {
    title: "Textually Correct Content",
    description:
      "Our experts understand the importance of textual content, making our service better than most.",
    offers: [
      "A team with understanding of all leading languages",
      "A team with understanding of all leading languages",
  ...
  {
    title: "Fact-Checked Transcriptions",
    description:
      "Our transcribers create documents that are factually and grammatically correct.",
    offers: [
      "Professional content scrutiny",
      "Thorough study of audio",
      "Precise results",
    ],
    icon: Lightbulb,
    color: "indigo",
  },
  {
    ...
    description:
      "We provide 24/7 customer service to ensure you receive the perfect final product.",
    offers: [
      "Trained and professional staff",
      "Niche centric support",
      "Dedicated transcription experts",
    ],
    icon: Clock,
    color: "indigo",
  },
  {
    ...
    description:
      "Our team is punctual, and we provide timely deliveries. So, when you’re working with us, you don’t have to worry about anything.",
    offers: [
      "Speedy results",
      "A knowledgeable team",
      "Genre centric approach",
    ],
    icon: CheckCircle,
    color: "indigo",
  },
  ...
  const buttonLabels = [
    "Textually Correct Content",
    "Fact-Checked Transcriptions",
    ...
    <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-25 py-12 lg:py-15 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          >
            Our skilled transcription team understands your demands
          </motion.p>
...
export default TranscriptionProposal;
