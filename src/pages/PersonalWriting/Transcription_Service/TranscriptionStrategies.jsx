...
import { Sparkles, Layers, Eye , CheckCircle    } from "lucide-react";
import { motion } from "framer-motion";

function TranscriptionStrategies() {
  ...
  const cardsData = [
    {
      ...
      description:
        "We pride ourselves on delivering error-free work and outstanding results to our clients.",
    ...
    },
    {
      ...
      description:
        "Transcribing documents should be versatile to make them more readable. Our transcription team ensures your documents are well-transcribed.",
    ...
    },
    {
      ...
      description:
        "Our team thoroughly reviews your audio and video files to ensure no important information is missed.",
    ...
    <div className="flex flex-col items-center w-full mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 bg-[url(https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/gradientBackground.png)]">
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-6xl mx-auto">
        ...
        <p className="text-sm md:text-md lg:text-lg text-gray-600 max-w-5xl mx-auto">
         We’re here to make your job easy, helping your organization be its best self. Our transcription writers are equipped with vast experience and help you unlock the doors of possibilities.
        </p>
      </div>
...
export default TranscriptionStrategies;
