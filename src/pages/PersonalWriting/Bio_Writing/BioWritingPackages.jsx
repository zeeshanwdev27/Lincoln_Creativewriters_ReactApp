...
function BioWritingPackages() {
  ...
  const packageData = {
    basic: [
      {
        package: "Short Bio",
        noOfArticles: `150 Words`,
        price: "$150",
        perArticle: "$30",
      },
      {
        package: "Corporate Bio",
        noOfArticles: `300 Words`,
        price: "$300",
        perArticle: "$45",
      },
      {
        package: "Professional Bio",
        noOfArticles: `500 Words`,
        price: "$500",
        perArticle: "$75",
      },
    ]
              ...
              {currentPackages.map((data, index) => (
                ...
                >
                  ...
                  <div className="hidden md:flex">
                    ...
                    {/* Per Article */}
                    <div className="flex-1 p-4 border-r border-indigo-200 text-gray-700">
                        <span className="text-indigo-600 text-lg font-bold">{data.perArticle}</span>
                    </div>
...
export default BioWritingPackages;