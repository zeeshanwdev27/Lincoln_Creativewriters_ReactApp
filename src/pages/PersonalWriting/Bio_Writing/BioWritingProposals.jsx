...
function BioWritingProposals() {
  const [activeFeature, setActiveFeature] = useState(0);

const features = [
  {
    title: "Expert Biographers",
    description:
      "What makes us stand out is our team of professional biographers. Our team excels in using the right words, from professional to personal bios.",
    offers: [
      "The right choice of words",
      "Research-backed facts",
      "Use of impactful keywords",
    ],
    icon: FileText,
    color: "indigo",
  },
  ...
  },
  {
    ...
    description:
      "At Lincoln Creative Writers, we are known for setting realistic timeframes and deadlines.",
    offers: [
      "Urgent revisions and alterations",
      "Project completion as per promised deadlines",
    ],
    icon: CheckCircle,
    color: "indigo",
  },
    ...
    <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-25 py-12 lg:py-15 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          >
           Captivating Biography Writing Services
          </motion.h1>
                    <motion.div
...
export default BioWritingProposals;
