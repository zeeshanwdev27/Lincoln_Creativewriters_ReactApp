...
const dummyData = [
  {
    image: "/PersonalWriting/BioWriting/biography-1.png",
    title: "Academic",
    description:
      "Well-structured academic bios that highlight your educational background, research interests, achievements, and scholarly contributions with clarity and professionalism.",
    features: [
      "Highlights academic achievements",
      "Showcases research focus",
      "Professional, formal tone",
    ],
  },
  {
    image: "/PersonalWriting/BioWriting/biography-2.png",
    title: "Personal",
    description:
      "Warm and relatable personal bios that capture your personality, life experiences, and unique journey in a compelling and authentic narrative.",
    features: [
      "Reflects your personality",
      "Authentic and relatable tone",
      "Highlights personal milestones",
    ],
  },
  {
    image: "/PersonalWriting/BioWriting/biography-3.png",
    title: "Professional",
    description:
      "Polished professional bios crafted to present your expertise, career accomplishments, and core strengths, ideal for resumes, portfolios, and corporate profiles.",
    features: [
      "Showcases career achievements",
      "Highlights core skills and expertise",
...
export default BioWritingContent;
