...
import { Sparkles, Trophy, Globe , Handshake    } from "lucide-react";
import { motion } from "framer-motion";

function ResumeStrategies() {
  ...
  const cardsData = [
    {
      ...
      description:
        "Secure more interviews with a resume for creative writers specifically that captivates employers. Our creative resume writing services are designed to highlight your skills in a compelling way, ensuring you stand out from the crowd.",
      color: "from-blue-500 to-cyan-500",
    },
    {
      icon: <Trophy className="w-8 h-8" />,
      title: "Achieve Higher Success Rates",
      description:
        "Experience a significant increase in callback rates with a polished, industry-specific resume. Our creative resume writing services are geared towards creative writers, bridging the gap between you and your dream job.",
      color: "from-green-500 to-emerald-500",
    },
    {
      icon: <Globe className="w-8 h-8" />,
      title: "Get Noticed in the Professional World",
      description:
        "Make a lasting impression with a resume that sets you apart. Our resume writing expertise for creative writers ensures you're not just another applicant, but the top choice for employers seeking creative talent.",
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-6xl mx-auto">
        ...
        >
          ...
          <span className="text-indigo-700 font-semibold text-sm">
            24 Hour Resume Writing Service
          </span>
        </motion.div>

        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-5">
          Partner With Our Writing Service {" "}
          <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
           Today and Step into A Brighter Future
          </span>
        </h1>

        <p className="text-sm md:text-md lg:text-lg text-gray-600 max-w-5xl mx-auto">
        To provide every job seeker, from recent graduates to seasoned professionals, with a resume and cover letter that truly reflects their value.
        </p>
      </div>
...
export default ResumeStrategies;
