...
const dummyData = [
  {
    image: "/PersonalWriting/Complaint/content1.png",
    title: "Complaint Letters",
    description:
      "Professionally written complaint letters that clearly communicate issues, concerns, or dissatisfaction while maintaining a respectful and solution-oriented tone.",
    features: [
  ...
  {
    image: "/PersonalWriting/Complaint/content2.png",
    title: "Complaint Response Letters",
    description:
      "Thoughtful and well-structured response letters that address complaints professionally, acknowledge concerns, and offer clear resolutions.",
    features: [
  ...
  {
    image: "/PersonalWriting/Complaint/content3.png",
    title: "Letter Of Disappointment",
    description:
      "Carefully crafted letters expressing disappointment in a calm, polite, and constructive manner, ensuring your message is heard without damaging relationships.",
    features: [
      "Polite yet firm tone",
      "Communicates expectations clearly",
      "Constructive and relationship-safe wording",
    ],
  },
];
    ...
    >
      ...
      >
        ...
        >
         ...
         Get the Best Complaint Writing Service Onboard
        </motion.div>
        ...
        <h1 className="text-4xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-4">
          Our Complaint Writers Add Meaning to Your Words
        </h1>
      </motion.div>
...
export default CompliantContent;
