...
import { Sparkles, ShieldCheck, PenTool , Headset     } from "lucide-react";
import { motion } from "framer-motion";

function CompliantStrategies() {

  const cardsData = [
    {
      icon: <PenTool className="w-8 h-8" />,
      title: "Dedicated Complaint Writers",
      description:
        "We have a skillful team of complaint writers who can add value to your words. We stay committed to helping you resolve matters with respect and mutual understanding.",
    ...
    },
    {
      ...
      description:
        "Your complaints might represent your discomfort, but we will ensure that you don’t get disappointed with us. Our writers will provide you with quality work that speaks to your concerns.",
    ...
    },
    {
      ...
      title: "24/7 Support",
      description:
        "We understand the cynicism that might erupt in your mind regarding the complaint letters. This is why we offer around-the-clock support to help you find the answers to your questions.",
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-6xl mx-auto">
        ...
        >
          ...
          <span className="text-indigo-700 font-semibold text-sm">
            Hire Professional Complaint Letter Writers
          </span>
        </motion.div>
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-5">
          ...
          <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
           That Present Your Case in An Elaborate Way
          </span>
        </h1>

        <p className="text-sm md:text-md lg:text-lg text-gray-600 max-w-5xl mx-auto">
      Our experienced complaint letter writers are fully equipped to forward your complaints to the concerned bodies. Their matchless talent of wordplay and perfect execution lets them present your concerns most elaborately.
        </p>
      </div>
...
export default CompliantStrategies;
