...
import { Sparkles, Headset , Search , PenTool    } from "lucide-react";
import { motion } from "framer-motion";

function GrantWritingStrategies() {
  const cardsData = [
    {
      icon: <Headset  className="w-8 h-8" />,
      title: "Transparent Communication",
      description:
        "Transparency is key between customer and client. We want to harbor a positive customer-client relationship with you. It’s why we keep you in the loop regarding your proposal writing process. In addition, we ensure open-ended communication throughout the process, just so you remain aware..",
      color: "from-blue-500 to-cyan-500",
    },
    {
      icon: <PenTool  className="w-8 h-8" />,
      title: "Seasoned Grant Writers",
      description:
        "As a grant writing company, we house writers from different backgrounds. Each writer has in-depth industry knowledge and a unique writing style, which makes each one of them a valuable asset to our team. With our grant writer services, you can ensure quality grant proposals.",
    ...
    },
    {
      ...
      description:
        "An effective grant proposal requires itself to be backed up by extensive research. With professional grant writing services, a dedicated team takes research seriously, ensuring that the information presented in the proposal can impress grant holders.",
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-7xl mx-auto">
        ...
        >
          ...
          <span className="text-indigo-700 font-semibold text-sm">
            What Sets Us Apart from Other Grant Writing Services?
          </span>
        </motion.div>

        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
          Our Grant Proposals are Trimmed{" "}
          <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
            Accordingly to Your Goals, Missions, And Values
          </span>{" "}
        </h1>

        <p className="text-sm md:text-md lg:text-lg text-gray-600 max-w-6xl mx-auto">
          We understand that. Unlike other grant writing companies, we ensure that each project we spearhead has a custom approach to ensure a higher success rate for the proposal approval.
        </p>
      </div>
...
export default GrantWritingStrategies;
