...
import { Sparkles, Puzzle, RefreshCcw   } from "lucide-react";
import { motion } from "framer-motion";

function BusinessPlanStrategies() {
  const cardsData = [
    {
      icon: <Puzzle className="w-8 h-8" />,
      title: "Tailor-Made Business Plans",
      description:
        "As seasoned pros in business plan writing, we want to ensure our clients are satisfied. Regardless of the business type, we will tailor it to your unique needs so that you get quality business plans and not a one-size-fits-all solution.",
    ...
    },
    {
      ...
      description:
        "For Lincoln Creative Writers, customer satisfaction is our top priority. We want to ensure that our service leaves our customers satisfied and content. We keep our communication lines open so you can stay in the loop of your business plan progress.",
    ...
    },
    {
      ...
      description:
        "With our business plan writing services, we want to ensure that you are content. It’s why we take the time to resolve any issues regarding your business plan. With Lincoln Creative Writers, you receive countless revisions to ensure you get what you expect.",
    ...
    <div className="flex flex-col items-center w-full mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 bg-[url(https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/gradientBackground.png)]">
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-7xl mx-auto">
        ...
        <p className="text-sm md:text-md lg:text-lg text-gray-600 max-w-6xl mx-auto">
          Our dedicated staff is our true asset. They come from diverse backgrounds, bringing their unique value. They possess great expertise in writing and can provide any agency business plan you need.
        </p>
      </div>
...
export default BusinessPlanStrategies;
