...
function PresentationProposal() {
  const [activeFeature, setActiveFeature] = useState(0);

const features = [
  {
    title: "Niche Centric Approach",
    description:
      "We understand that the world is changing rapidly, and so are the needs of our clients. Our PowerPoint presentation writing services are designed keeping in mind the unique needs of your clients. Each of the writers opts for a niche-centric approach that enables them to provide you with content that matches your demands.",
    offers: [
      "Customized content solutions",
      "24/7 consultancy for improved execution",
    ],
    icon: Repeat,
    color: "indigo",
  },
  {
    ...
    description:
      "We at Lincoln Creative Writers are home to writers that bring years of experience in their hats. Our team remains committed to transforming your vision into words that have a lasting impression on your audience. Our writers deploy market-competitive writing styles that keep your audience hooked until the presentation lasts.",
    offers: [
      "Countless writing styles that match your demands",
      "Dedicated writers for your project",
    ],
    icon: PenTool,
    color: "indigo",
  },
  {
    ...
    description:
      "Content is king, and we cannot endorse it enough. We understand the changing market demands and have worked tirelessly to curate content driven by value. Research drives our content so that you can educate your audience with facts and figures. Our writers thoroughly comprehend your image and develop relevant content that speaks for itself.",
    offers: [
      "Plagiarism free content",
      "Unlimited revisions and room for customizations",
    ],
    icon: FilePenLine ,
    color: "indigo",
  },
  {
    title: "Our Results-drive Efforts",
    description:
      "Our infographic services continue to help businesses attract a broad audience. We understand that people don't have the time to read boring content generally. But with our infographics, the designs are not only appealing, but also the content is concise, exciting, and engaging.",
    offers: [
      "Around-the-clock suppor",
      "A wide range of custom presentation templates"
    ],
    icon: Trophy ,
    color: "indigo",
  },
  ...
  const buttonLabels = [
    "Niche Centric Approach",
    "An Experienced Team",
    "Relevant Content",
    "Our Results-drive Efforts",
  ];
    ...
    <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-25 py-12 lg:py-15 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          >
            Creative press release to make an impact
          </motion.h1>
...
export default PresentationProposal;
