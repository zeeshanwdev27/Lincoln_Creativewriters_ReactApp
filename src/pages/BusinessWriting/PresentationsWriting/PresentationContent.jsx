...
const dummyData = [
  {
    image: "/BusinessWriting/Presentation/Content/img1.png",
    title: "Informative Presentation",
    description:
      "Create presentations that clearly convey complex information, keeping your audience engaged while ensuring key points are understood.",
    features: [
      "Simplifies complex topics",
      "Engages and educates audience",
      "Visually clear and structured slides",
    ],
  },
  {
    image: "/BusinessWriting/Presentation/Content/img2.png",
    title: "Sales Presentation",
    description:
      "Design persuasive sales presentations that highlight your product’s value, address client needs, and drive conversions effectively.",
    features: [
      "Focuses on product benefits",
      "Persuasive and audience-driven",
      "Encourages decision-making and sales",
    ],
  },
  {
    image: "/BusinessWriting/Presentation/Content/img3.png",
    title: "Image Building Presentation",
    description:
      "Craft presentations that enhance brand image, showcase achievements, and build trust with clients, partners, and stakeholders.",
    features: [
      "Highlights brand strengths",
    ...
    >
      ...
      >
        ...
        >
         ...
         Hire Professional Presentation Writers Today
        </motion.div>
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-5xl xl:text-6xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-4">
          Eye-Catching Content <br /> That Resonates with Your Goals
        </h1>
      </motion.div>
