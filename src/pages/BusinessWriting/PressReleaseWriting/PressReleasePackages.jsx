    ...
    basic: [
      {
        ...
        noOfArticles: `10 Press Releases`,
        price: "$350",
        perArticle: "$35",
      },
      {
        package: "Silver (300 words)",
        noOfArticles: `20 Press Releases`,
        price: "$600",
        perArticle: "$30",
      },
      {
        package: "Gold (300 words)",
        noOfArticles: `40 Press Releases`,
        price: "$1000",
        perArticle: "$25",
      },
    ]
      ...
      >
        ...
        >
          ...
          <div className="hidden md:flex bg-indigo-500 text-white font-semibold">
            ...
            <div className="flex-1 p-4 border-r border-indigo-400">No. of Press Releases</div>
            <div className="flex-1 p-4 border-r border-indigo-400">Price</div>
            <div className="flex-1 p-4 border-r border-indigo-400">Per PR</div>
