...
function PressReleaseProposals() {
...
const features = [
  {
    ...
    description:
      "Let us help you with any revisions you need. Our editor will revise it until it reaches A-level standards. Professional proofreaders check every document carefully.",
    offers: [
      "Unlimited revisions until you’re fully satisfied",
      "Expert proofreading for clarity and accuracy",
      "Guaranteed improvement to top-tier standards",
    ],
    icon: Repeat,
    color: "indigo",
  },
  {
    ...
    description:
      "Our writers can assist you with any type of assignment you may have. We are providing academic papers of all levels with unlimited revisions.",
    offers: [
      "Experienced writers from diverse industries",
      "Well-researched, tailored, and impactful writing",
      "Flawless grammar, tone, and presentation",
    ],
    icon: PenTool,
    color: "indigo",
  },
  {
    ...
    description:
      "You can call for help whenever you need it. Whenever you need us, our customer support team is available 24 hours a day, seven days a week.",
    offers: [
      "24/7 responsive support via chat and email",
  ...
  {
    title: "Free Plagiarism Work",
    description:
      "We never use any plagiarism in our essays. A free plagiarism report also accompanies every paper. We guarantee zero plagiarism.",
    offers: [
      "100% original and authentic content",
      "Complimentary plagiarism report with every order",
      "Strict adherence to originality standards",
    ],
    icon: FileCheck,
    color: "indigo",
  },
  {
    ...
    description:
      "We guarantee on-time delivery with our team of professional writers. We also complete about half the work before the deadline. Your teacher will then review everything you submit.",
    offers: [
      "Guaranteed on-time or early submissions",
      "Efficient workflow for fast turnaround",
  ...
  },
  {
    title: "100% Privacy",
    description:
      "Any data we share will be handled carefully. Also, we use the latest technology to safeguard all communication. Our security measures are the best, and we never reveal your data.",
    offers: [
...
export default PressReleaseProposals;
