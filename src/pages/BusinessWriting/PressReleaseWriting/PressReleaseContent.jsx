...
const dummyData = [
  {
    image: "/BusinessWriting/PressReleaseWriting/Content/blog.png",
    title: "Book Press Releases",
    description:
      "Our book press releases help authors gain visibility by announcing new titles, book launches, and author interviews to the right audience through impactful storytelling.",
    features: [
      "Promotes book launches effectively",
      "Builds author visibility",
      "Captures media and reader attention",
    ],
  },
  {
    image: "/BusinessWriting/PressReleaseWriting/Content/calltoaction.png",
    title: "Event Press Releases",
    description:
      "We craft compelling event press releases that generate excitement, highlight key details, and encourage strong audience participation or media coverage.",
    features: [
      "Drives attendance and interest",
      "Highlights event details clearly",
      "Encourages media engagement",
    ],
  },
  {
    image: "/BusinessWriting/PressReleaseWriting/Content/landingpage.png",
    title: "Business Press Releases",
    description:
      "Our business press releases are written to announce company milestones, partnerships, and product launches—enhancing brand credibility and visibility in your industry.",
    features: [
      "Announces business achievements",
      "Strengthens brand reputation",
      "Targets media and investors effectively",
    ],
  },
];
    ...
    >
      ...
      >
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-4">
          Effective Press Releases Writing
        </h1>
      </motion.div>
