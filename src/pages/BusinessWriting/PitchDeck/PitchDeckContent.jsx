...
const dummyData = [
  {
    image: "/BusinessWriting/PitchDesk/Content/pitchdeck-1.png",
    title: "The Investor Pitch",
    description:
      "We craft powerful investor pitch decks that clearly communicate your business vision, financial potential, and growth strategy to attract the right investors.",
    features: [
  ...
  {
    image: "/BusinessWriting/PitchDesk/Content/pitchdeck-2.png",
    title: "The Elevator Pitch",
    description:
      "Our elevator pitches help you capture attention fast — delivering your idea in a clear, concise, and memorable way that leaves a lasting impression.",
    features: [
      "Concise Messaging",
  ...
  {
    image: "/BusinessWriting/PitchDesk/Content/pitchdeck-3.png",
    title: "The Sales Pitch",
    description:
      "We create persuasive sales pitches that highlight your product’s unique benefits, overcome objections, and motivate clients to take immediate action.",
    features: [
  ...
  {
    image: "/BusinessWriting/PitchDesk/Content/pitchdeck-4.png",
    title: "The Traction Pitch",
    description:
      "Our traction pitch decks demonstrate your business growth, achievements, and market validation — building investor confidence through results and milestones.",
    features: [
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex flex-col gap-4 text-center mb-12 lg:mb-16">
        ...
        >
          ...
          Uncover Exceptional Pitch Deck Consulting Services
        </motion.div>
        
        <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4">
         Types Of <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent ">Pitch Decks</span>
        </h1>
