...
function PitchDeckPackages() {
  ...
  const packageData = {
    basic: [
      {
        package: "Basic Grant",
        noOfArticles: `10+ Pages`,
        price: "Less than $25000",
        perArticle: "$675",
      },
      {
        package: "Standard Grant",
        noOfArticles: `15+ Pages`,
        price: "Less than $75000",
        perArticle: "$1,500",
      },
      {
        package: "Premium Grant",
        noOfArticles: `20+ Pages`,
        price: "Less than $150000",
        perArticle: "$2,250",
      },
    {
        package: "Deluxe Grant",
        noOfArticles: `25+ Pages`,
        price: "Greater than $150000",
        perArticle: "$2,925",
      },
    ]
  };
    ...
    <div className=" bg-gradient-to-br from-indigo-50 to-white py-12 lg:py-20 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        >
          ...
          >
            Choose From a Collection of Winning Designs
          </motion.h1>
          <motion.p
          ...
          >
            Here’s everything you need to attract, engage, and impress potential investors, stakeholders, and partners. Calculate your prices below.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          <div className="hidden md:flex bg-indigo-500 text-white font-semibold">
            ...
            <div className="flex-1 p-4 border-r border-indigo-400">Funding</div>
              ...
              {currentPackages.map((data, index) => (
                ...
                >
                  ...
                  <div className="hidden md:flex">
                    ...
                    {/* Per Article */}
                    <div className="flex-1 p-4 border-r border-indigo-200">
                          <span className="text-indigo-600 font-bold text-lg">{data.perArticle}</span>
                    </div>
...
export default PitchDeckPackages;