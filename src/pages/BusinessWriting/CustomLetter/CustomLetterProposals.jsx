...
function CustomLetterProposals() {
  const [activeFeature, setActiveFeature] = useState(0);

const features = [
  {
    title: "Expert Letter Writers",
    description:
      "We at Lincoln Creative Writers take pride in being the home of specialized letter writers. Our dedicated team brings years of experience and remains committed to drafting letters that offer value to our clients and recipients.",
    offers: [
      "Years of experience",
  ...
  },
  {
    ...
    description:
      "We understand that questions and queries can erupt anytime during the process. This is why we offer around-the-clock support to ensure customer satisfaction allowing you to stay looped in throughout the process. Our writers are always ready to respond to your various queries.",
    offers: [
  ...
  {
    title: "We Understand the Tone",
    description:
      "Our trained letter-writing experts acknowledge the importance of the right tone when drafting a letter. We create engaging and moving letters that leave the readers in awe. We deploy modern writing practices to make your letters sound more like you.",
    offers: [
      "Engaging and captivating tone",
      "Unique writing style for each letter",
    ],
    icon: Feather ,
    color: "indigo",
  },
  {
    ...
    description:
      "We understand that your needs might change at any point during the letter-writing process. That’s what makes Lincoln Creative Writers offer countless revisions so you can get the desired results. Our writers will do everything required to satisfy you, allowing you to craft a letter that speaks for you.",
    offers: [
      "Countless revisions per project",
      "Guaranteed results"
    ],
    icon: Repeat ,
    color: "indigo",
  ...
  const buttonLabels = [
    "Expert Letter Writers",
    "Around the Clock Support",
    "We Understand the Tone",
    "Unlimited Revisions",
  ];
    ...
    <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-25 py-12 lg:py-15 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          >
           Here’s What Makes Us the Best in Business
          </motion.p>
...
export default CustomLetterProposals;
