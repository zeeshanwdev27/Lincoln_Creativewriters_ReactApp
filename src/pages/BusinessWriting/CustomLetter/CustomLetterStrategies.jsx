...
import { Sparkles, Mic, Star, FileText   } from "lucide-react";
import { motion } from "framer-motion";

function CustomLetterStrategies() {

  const cardsData = [
    {
      icon: <FileText  className="w-8 h-8" />,
      title: "Crisp and Concise",
      description:
        "Our professional letter writers can dig deeper into each detail you provide, transforming it into a letter with credibility and weightage, communicating your message according to your expectations.",
      color: "from-blue-500 to-cyan-500",
    },
    {
      icon: <Mic  className="w-8 h-8" />,
      title: "We Catch the Tone",
      description:
        "We believe every letter is unique and holds great expressive value for the sender and the recipient. That makes our writers catch the tone and craft a letter that encapsulates your words and emotions.",
    ...
    },
    {
      ...
      description:
        "We are home to professional letter writers with years of experience behind them. Our dedicated team guarantees to produce high-quality original content for every letter so you can communicate your feelings in the best possible way.",
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-6xl mx-auto">
        ...
        >
          ...
          <span className="text-indigo-700 font-semibold text-sm">
            Hire Professional Letter Writing Service
          </span>
        </motion.div>
        ...
        <p className="text-sm md:text-md lg:text-lg text-gray-600 max-w-5xl mx-auto">
          We at Lincoln Creative understand that not all letters are of the same magnitude. Our trained letter-writing experts craft concise, compelling, and creative letters that communicate your message in a tone that fits your needs.
        </p>
      </div>
...
export default CustomLetterStrategies;
