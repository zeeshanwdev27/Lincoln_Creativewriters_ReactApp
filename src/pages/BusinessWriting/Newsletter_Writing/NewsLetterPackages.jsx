...
function NewsLetterPackages() {
  const [activeTab, setActiveTab] = useState("basic");

  const packageData = {
    basic: [
      {
        package: "Bronze (50-100 words)",
        noOfArticles: `With Design`,
        price: "$70",
        perArticle: "$10",
      },
      {
        package: "Silver (100-150 words)",
        noOfArticles: `With Design`,
        price: "$85",
        perArticle: "$18",
      },
      {
        package: "Gold (150-200 words)",
        noOfArticles: `With Design`,
        price: "$99",
        perArticle: "$35",
      },
        {
        package: "Newsletters Content",
...
export default NewsLetterPackages;