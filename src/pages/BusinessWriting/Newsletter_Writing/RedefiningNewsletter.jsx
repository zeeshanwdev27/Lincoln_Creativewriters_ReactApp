...
import { Sparkles, MessageCircle, Eye , PenTool } from "lucide-react";
import { motion } from "framer-motion";

function RedefiningNewsletter() {
  const cardsData = [
    {
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-6xl mx-auto">
        ...
        >
          ...
          <span className="text-indigo-700 font-semibold text-sm">
           Hire a Newsletter Writer Online
          </span>
        </motion.div>
...
export default RedefiningNewsletter;
