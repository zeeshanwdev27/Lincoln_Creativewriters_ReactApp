  ...
  const features = [
    {
      ...
      description:
        "We have trained writers that can provide you with different types of newsletters depending on your goals and the targeted demographics. Our writers will help you communicate your message profoundly.",
      offers: [
        "Guaranteed results",
        "Native writers",
        "100% original",
    ...
    {
      title: "In-depth Brainstorming",
      description:
        "Our professional content writers ensure to get thorough research done about the business before drafting an effective newsletter. This approach helps us to understand the business's intent and operate accordingly.",
      offers: [
        "Proficient writers",
        "Authentic sources",
        "Market competitive",
    ...
    },
    {
      ...
      description:
        "We are home to professional content writers with distinctive writing styles, and each of them is capable of adapting to different tones according to the requirements of our valued clients.",
      offers: [
        "Skillful authors",
        "Expert researchers",
        "Adaptive mindset",
    ...
    },
    {
      title: "Get Satisfied",
      description:
        "As a team of professional content writers, the satisfaction of our valued clients is our utmost priority. Our skilled creative writers aim to match the client's goals with each project.",
      offers: [
        "Professional approach",
        "Native writers",
        "24/7 support",
    ...
    <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-25 py-12 lg:py-15 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          >
            What Makes Our Proposals Effective?
          </motion.h1>
...
export default NewsLetterProposal;
