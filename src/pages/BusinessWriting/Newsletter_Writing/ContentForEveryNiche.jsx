...
const dummyData = [
  {
    image: "/BusinessWriting/NewsLetter/newsletter-1.png",
    title: "Company Email Newsletters",
    description:
      "Professional newsletters tailored for companies to keep employees and stakeholders informed, engaged, and aligned with company updates and initiatives.",
    features: [
  ...
  {
    image: "/BusinessWriting/NewsLetter/newsletter-2.png",
    title: "Consumer Email Newsletters",
    description:
      "Engaging newsletters designed for consumers to promote products, share valuable insights, and strengthen brand loyalty with informative and visually appealing content.",
    features: [
  ...
  {
    image: "/BusinessWriting/NewsLetter/newsletter-3.png",
    title: "Organizational Newsletters",
    description:
      "Strategically crafted newsletters for organizations to share internal updates, success stories, and key announcements, keeping teams informed and motivated.",
    features: [
      "Highlights key organizational updates",
    ...
    >
      ...
      >
        ...
        >
         ...
         Hire Professional Newsletter Writing Service
        </motion.div>
...
export default ContentForEveryNiche;
