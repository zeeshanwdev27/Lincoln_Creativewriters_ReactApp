...
function EmailWritingProposal() {
  const [activeFeature, setActiveFeature] = useState(0);

  const features = [
    {
      title: "Unlimited Free Revision",
      description:
        "Perfection is what we aim for while offering our email writing services.",
      offers: [
        "Get exactly what you need with unlimited revisions",
    ...
    },
    {
      ...
      description:
        "Be it designing email campaigns or job application emails. Our professional email writers know precisely how to ace different types of emails.",
      offers: [
        "We have a team of diverse writers",
        "Use of industry-appropriate verbiage",
      ],
      icon: BookOpen,
      color: "indigo",
    },
    {
      ...
      description:
        "You can call for help whenever you need it. Whenever you need us, our customer support team is available 24 hours a day, seven days a week. Your order will be fixed if there are any problems.",
      offers: [
        "Receive responses to queries in the shortest possible timeframe",
        "Get your changes and requests catered urgently",
      ],
      icon: Headset,
      color: "indigo",
    },
    {
      ...
      description:
        "At Lincoln Creative Writers, we are known for delivering quality content within the promised deadlines.",
      offers: [
        "We share realistic deadlines",
        "Project completion within promised deadlines",
      ],
      icon: Clock ,
      color: "indigo",
    },
    ...
    <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-25 py-12 lg:py-15 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          >
            What Makes Our Email Letter Writing Effective?
          </motion.h1>
...
export default EmailWritingProposal;
