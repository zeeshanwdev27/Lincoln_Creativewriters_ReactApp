...
const dummyData = [
  {
    image: "/BusinessWriting/Email/Content/email-1.png",
    title: "Business Emails",
    description:
      "We craft professional and impactful business emails that reflect your brand’s tone, maintain clarity, and achieve your communication goals effectively.",
    features: [
      "Professional Tone",
  ...
  {
    image: "/BusinessWriting/Email/Content/email-2.png",
    title: "Job Application Emails",
    description:
      "Make the right first impression with expertly written job application emails that highlight your strengths, professionalism, and enthusiasm for the role.",
    features: [
  ...
  {
    image: "/BusinessWriting/Email/Content/email-3.png",
    title: "Email Campaigns",
    description:
      "We design persuasive and engaging email campaigns that drive engagement, nurture leads, and convert your audience with strategic messaging and creative flair.",
    features: [
      "Engaging Copy",
