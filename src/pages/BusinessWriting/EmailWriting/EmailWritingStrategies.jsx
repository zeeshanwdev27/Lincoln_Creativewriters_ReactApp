...
import { Sparkles, Headset , Mail, Send     } from "lucide-react";
import { motion } from "framer-motion";

function EmailWritingStrategies() {
  const cardsData = [
    {
      icon: <Headset  className="w-8 h-8" />,
      title: "EMAILS FROM CUSTOMER SERVICE",
      description:
        "Consumer service emails are intended to resolve and respond to customer inquiries and problems.",
      color: "from-blue-500 to-cyan-500",
    },
    {
      icon: <Send  className="w-8 h-8" />,
      title: "CONTENT OF THE NEWSLETTER EMAIL",
      description:
        "Promotional emails notifying clients of brand activity and other information",
      color: "from-green-500 to-emerald-500",
    },
    {
      icon: <Mail    className="w-8 h-8" />,
      title: "OFFICIAL & BUSINESS EMAILS",
      description:
        "Emails intended for official business and proposal correspondence.",
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-7xl mx-auto">
        ...
        >
          ...
          <span className="text-indigo-700 font-semibold text-sm">
            Hire Professional Email Copywriting Service
          </span>
        </motion.div>
        ...
        <p className="text-sm md:text-md lg:text-lg text-gray-600 max-w-6xl mx-auto">
          We provide formal email writing services for your daily email correspondence—straightforward and reasonable service. You have to send us the bullet points, even if it's only a single word or phrase in each line, and we'll write you a concise email.
        </p>
      </div>
...
export default EmailWritingStrategies;
