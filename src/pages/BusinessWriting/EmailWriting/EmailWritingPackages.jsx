...
function EmailWritingPackages() {
  const [activeTab, setActiveTab] = useState("basic");

  const packageData = {
    basic: [
      {
        package: "03 Custom Emails",
        noOfArticles: `350 words/500 words	`,
        price: "$105",
        perArticle: "$150",
      },
      {
        package: "05 Custom Emails",
        noOfArticles: `350 words/500 words`,
        price: "$175",
        perArticle: "$250",
      },
      {
        package: "10 Custom Emails",
        noOfArticles: `350 words/500 words`,
        price: "$350",
        perArticle: "$500",
      },
    ...
    <div className=" bg-gradient-to-br from-indigo-50 to-white py-12 lg:py-20 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        >
          ...
          >
            We have seasoned creative writers on board who are capable of offering services for a wide range of writing projects.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          <div className="hidden md:flex bg-indigo-500 text-white font-semibold">
            <div className="flex-1 p-4 border-r border-indigo-400">Custom Emails</div>
            <div className="flex-1 p-4 border-r border-indigo-400">No. of Words</div>
            <div className="flex-1 p-4 border-r border-indigo-400">Price/350words</div>
            <div className="flex-1 p-4 border-r border-indigo-400">Price/500words</div>
...
export default EmailWritingPackages;