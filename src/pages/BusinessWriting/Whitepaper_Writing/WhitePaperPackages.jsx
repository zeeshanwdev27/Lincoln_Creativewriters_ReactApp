...
function WhitePaperPackages() {
  const [activeTab, setActiveTab] = useState("basic");

  const packageData = {
    basic: [
      {
        package: "Short White Paper",
        noOfArticles: `5 Pages`,
        price: "$199",
      },
      {
        package: "Long White Paper",
        noOfArticles: `10 Pages`,
        price: "$375",
      },
      {
        package: "Corporate White Paper",
      ...
      >
        ...
        >
          ...
          <div className="hidden md:flex bg-indigo-500 text-white font-semibold">
            <div className="flex-1 p-4 border-r border-indigo-400">Package</div>
...
export default WhitePaperPackages;