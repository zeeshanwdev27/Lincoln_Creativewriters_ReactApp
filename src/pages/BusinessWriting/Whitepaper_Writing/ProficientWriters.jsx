...
import { Sparkles, FileSearch, ClipboardList , Briefcase } from "lucide-react";
import { motion } from "framer-motion";

function ProficientWriters() {
  const cardsData = [
    {
      icon: <FileSearch className="w-8 h-8" />,
      title: "Research Based",
      description:
        "We generate content after conducting thorough market research.",
    ...
    },
    {
      ...
      title: "Planning",
      description:
        "All projects are perfectly planned in line with client requirements",
    ...
    },
    {
      ...
      description:
        "Each paper adopts a professional tone essential for success in the market",
    ...
    <div className="flex flex-col items-center w-full mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 bg-[url(https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/gradientBackground.png)]">
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-6xl mx-auto">
        ...
        <p className="text-sm md:text-md lg:text-lg text-gray-600 max-w-4xl mx-auto">
          Hire Lincoln Creative Writers for an authoritative piece of content that reflects the industry’s best practices and includes expert opinions. Use professional white paper content writing services in the U.S to market your business.
        </p>
      </div>
...
export default ProficientWriters;
