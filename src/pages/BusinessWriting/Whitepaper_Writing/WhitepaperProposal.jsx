  ...
  const features = [
    {
      title: "Research",
      description:
        "Whitepapers need authentic information and research. We plan each project depending on its technicalities. Our goal is to produce professional whitepapers that make a difference.",
      offers: [
        "Thorough comprehension of each project",
        "Professional consultancy by industry experts",
        "Proper implementation of detailed ideas",
        "Relying on 100% authentic resources",
      ],
      icon: Search,
      color: "indigo",
    },
    {
      ...
      description:
        "We understand that writing a high-quality whitepaper requires something more than a positive approach. Our professional writers opt for unique methods for every whitepaper project.",
      offers: [
        "Around-the-clock customer support",
        "A thorough study of various projects",
        "100% verified and authentic resources",
        "Plagiarism free content every time",
      ],
      icon: BookOpen,
      color: "indigo",
    },
    {
      ...
      description:
        "We are home to a family of professional writers who understand the complexity of each whitepaper project. Each writer possesses unique writing styles and methods.",
      offers: [
        "Adaptive tactics for each project",
        "Creative, diverse, and original ideas",
        "An Exceptional and comprehensive writing approach",
        "Open to new ideas and writing techniques",
      ],
      icon: PenTool,
      color: "indigo",
    },
    {
      ...
      description:
        "Lincoln Creative Writers believe in the originality of our content. Our writers strictly adhere to our zero-tolerance policy against plagiarism while working on whitepaper projects.",
      offers: [
        "Verified resources for each whitepaper project",
        "Numerous quality checks to maintain authenticity",
        "No tolerance for any plagiarized content",
        "Various workshops to enforce content originality",
      ],
      icon: RefreshCw,
      color: "indigo",
    },
    ...
    <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-25 py-12 lg:py-15 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          >
            Professional White Paper Technical Writing
          </motion.h1>
...
export default WhitepaperProposal;
