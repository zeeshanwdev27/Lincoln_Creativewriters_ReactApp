...
import { Sparkles, RefreshCcw, Layers , Globe    } from "lucide-react";
import { motion } from "framer-motion";

function ProductDescriptionStrategies() {
  ...
  const cardsData = [
    {
      ...
      description:
        "Appear in thousands of searches with our capability to integrate useful keywords. Our SEO product description writing services can do wonders for your products. With us as your partner, you can make your online store more visible in the virtual space.",
    ...
    },
    {
      ...
      description:
        "Lincoln Creative Writers is purely customer-centric. Apart from our quality services, you're also a crucial piece that plays a part in our product description writing. If you have any concerns, we can offer unlimited revisions until we get the content you envisioned.",
      color: "from-green-500 to-emerald-500",
    },
    {
      icon: <Layers className="w-8 h-8" />,
      title: "Refresh Your Website",
      description:
        "If you're considering revamping your website, it's a great time to refresh your overall product description on your online store. By hiring a product description agency, you can have them prepare product description copies based on current data.",
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-6xl mx-auto">
        ...
        >
          ...
          <span className="text-indigo-700 font-semibold text-sm">
            Partner Up with Lincoln Creative Writers to Power your Online Store
          </span>
        </motion.div>
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-5">
          ...
          <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
           Product Descriptions for Every Niche
          </span>
        </h1>

        <p className="text-sm md:text-md lg:text-lg text-gray-600 max-w-5xl mx-auto">
       Our Product Description Writers for Hire Can Describe Your Products Greatly, Helping You Increase Sales.
        </p>
      </div>
...
export default ProductDescriptionStrategies;
