...
const dummyData = [
  {
    image: "/DigitalSolution/Webcontent/content1.png",
    title: "Website Content",
    description:
      "Engaging website content crafted to inform, persuade, and convert visitors while reflecting your brand’s voice and values.",
    features: [
      "Clear, compelling, and audience-focused copy",
      "Optimized for SEO and readability",
      "Aligns with brand messaging and tone",
    ],
  },
  {
    image: "/DigitalSolution/Webcontent/content2.png",
    title: "Call To Action",
    description:
      "Powerful CTAs designed to drive user engagement and encourage visitors to take meaningful actions on your website.",
    features: [
      "Persuasive language to boost conversions",
      "Strategically placed for maximum impact",
      "Tailored to specific user goals and actions",
    ],
  },
  {
    image: "/DigitalSolution/Webcontent/content3.png",
    title: "Landing Pages",
    description:
      "High-converting landing pages that guide visitors smoothly through the sales funnel and encourage them to take desired actions.",
    features: [
      "Optimized structure for user flow and conversions",
      "Engaging headlines and compelling content",
      "Custom design aligned with brand strategy",
    ],
  },
  {
    image: "/DigitalSolution/Webcontent/content4.png",
    title: "Testimonials",
    description:
      "Authentic and persuasive testimonials that build trust, credibility, and confidence in your products or services.",
    features: [
      "Highlight customer success stories effectively",
      "Crafted to enhance brand credibility",
      "Designed to boost user trust and conversions",
    ],
  },
];
