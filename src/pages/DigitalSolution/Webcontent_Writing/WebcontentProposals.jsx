...
const features = [
  {
    title: "Get Noticed",
    description:
      "Get improved reach with the tailored web content developed by our writers. Our skillful writers will ensure that your business gets all the attention it deserves to thrive.",
    offers: [
      "Better visibility",
      "Skillful authors",
      "Improved SEO",
  ...
  },
  {
    ...
    description:
      "Every click is an opportunity to create new leads and boost sales. Our creative content writers work on a goal-driven agenda to make things simple for you.",
    offers: [
      "Boost sales",
  ...
  },
  {
    title: "SEO Supremacy!",
    description:
      "Our content optimization capabilities guarantee to get you more traffic through increased visibility in global search engines. Attract clients from all around the world with our tailored content.",
    offers: [
      "Improved results",
      "Better visibility",
      "Global sales",
  ...
  {
    title: "Great Professionals",
    description:
      "We are home to expert content writers from every field. All of your content needs will find their home here. Get in touch right now for guaranteed results.",
    offers: [
      "Native writers",
      "Zero plagiarism",
      "Professional tone",
...
export default WebcontentProposals;
