...
function GuestPostSample() {
  const cardsData = [
    { title: "Guest Sample 1", image: "/DigitalSolution/GuestPost/Sample/sample1.png", pdfLink : '/DigitalSolution/GuestPost/Sample/sample1.pdf', },
    { title: "Guest Sample 2", image: "/DigitalSolution/GuestPost/Sample/sample2.png", pdfLink : '/DigitalSolution/GuestPost/Sample/sample2.pdf'},
    { title: "Guest Sample 3", image: "/DigitalSolution/GuestPost/Sample/sample3.png", pdfLink : '/DigitalSolution/GuestPost/Sample/sample3.pdf'},
  ];
...
export default GuestPostSample;