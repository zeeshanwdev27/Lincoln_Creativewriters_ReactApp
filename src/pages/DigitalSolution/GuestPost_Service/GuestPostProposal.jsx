...
function GuestPostProposal() {
  const [activeFeature, setActiveFeature] = useState(0);

const features = [
  {
    title: "Branding at its finest",
    description:
      "Do you want to benefit from higher SEO rankings? Our guest blog services are here to help. Our experts ensure your blog is published on the best platform to increase brand image.",
    offers: [
      "Premium placements on high-authority websites",
      "Brand exposure that boosts credibility and SEO ranking",
    ],
    icon: BadgeCheck,
    color: "indigo",
  },
  {
    title: "Capitalizing on referral traffic",
    description:
      "We publish guest posts to other sites to improve your referral traffic, benefiting you with your very own built-in audience.",
    offers: [
      "Traffic sourced directly from relevant niche platforms",
      "Engaging posts designed to convert readers into visitors",
    ],
    icon: TrendingUp,
    color: "indigo",
  },
  {
    title: "Maximize online authority",
    description:
      "Our guest posting will help build consumer trust with your brand. When other websites publish your content, it pitches you as an industry expert.",
    offers: [
      "Authority-driven content that positions you as a leader",
      "Backlinks from trusted sites to strengthen reputation",
    ],
    icon: Crown,
    color: "indigo",
  },
  {
    ...
    description:
      "Our experts will not only publish remarkable content on different websites but will also use them for marketing your social presence. This will help your brand build authority.",
    offers: [
      "Guest posts optimized for social sharing and engagement",
      "Boosted visibility across multiple digital platforms",
    ],
    icon: Users,
    color: "indigo",
  },
  ...
  const buttonLabels = [
    ...
    "Capitalizing on referral traffic",
    "Maximize online authority",
    ...
    <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-25 py-12 lg:py-15 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          >
           Professional Health Blog Guest Posts
          </motion.h1>
                    <motion.div
...
export default GuestPostProposal;
