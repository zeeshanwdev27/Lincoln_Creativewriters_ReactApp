...
function GuestPostPackages() {
  const [activeTab, setActiveTab] = useState("basic");

  const packageData = {
    basic: [
      {
        package: "1 Basic Guest Blog",
        noOfArticles: `30+`,
        price: "$75",
        perArticle: "$10",
      },
      {
        package: "5 Basic Guest Blogs",
        noOfArticles: `30+`,
        price: "$375",
        perArticle: "$18",
      },
      {
        package: "1 Standard Guest Blog",
        noOfArticles: `40+`,
        price: "$100",
        perArticle: "$35",
      },
        {
        package: "5 Standard Guest Blogs",
        noOfArticles: `40+`,
        price: "$500",
        perArticle: "$35",
      },
      ...
      >
        ...
        >
          ...
          <div className="hidden md:flex bg-indigo-500 text-white font-semibold">
            <div className="flex-1 p-4 border-r border-indigo-400">Guest Blogs</div>
            <div className="flex-1 p-4 border-r border-indigo-400">DA </div>
            <div className="flex-1 p-4 border-r border-indigo-400">Price</div>
            <div className="flex-1 p-4 border-r border-indigo-400">Custom Price </div>
                  ...
                  <div className="hidden md:flex">
                    ...
                    <div className="flex-1 p-4 border-r border-indigo-200 text-gray-700">
                      {data.perArticle === "Live Chat" ? (
                        ...
                        <span className="flex items-center gap-1 text-green-500 text-bold"> <MessageCircle className="w-4 h-4"/> Live Chat </span>
                      )}
                    </div>
...
export default GuestPostPackages;