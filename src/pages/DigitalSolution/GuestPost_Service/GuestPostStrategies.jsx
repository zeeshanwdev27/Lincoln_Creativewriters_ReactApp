...
import { Sparkles, Link, LayoutDashboard , Gauge    } from "lucide-react";
import { motion } from "framer-motion";

function GuestPostStrategies() {

  const cardsData = [
    {
      icon: <Link className="w-8 h-8" />,
      title: "Proper Link Building",
      description:
        "We perform link building in the safest way possible.",
      color: "from-blue-500 to-cyan-500",
    },
    {
      icon: <LayoutDashboard  className="w-8 h-8" />,
      title: "Intuitive Web Platforms",
      description:
        "Our guest posts are uploaded on intuitive web platforms for optimal results",
    ...
    },
    {
      ...
      title: "Quick Results",
      description:
        "Our guest post services are quick, reliable, and affordable.",
    ...
    <div className="flex flex-col items-center w-full mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 bg-[url(https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/gradientBackground.png)]">
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-7xl mx-auto">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-gray-900 mb-5">
          Increased outreach   <br />
          <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
            with Blog Posting Services
          </span>{" "}
        </h1>

        <p className="text-sm md:text-md lg:text-lg text-gray-600 max-w-5xl mx-auto">
         Our guest posting offers you the best way to get natural links to your site.
        </p>
      </div>
...
export default GuestPostStrategies;
