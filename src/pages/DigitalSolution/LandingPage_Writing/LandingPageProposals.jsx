...
function LandingPageProposals() {
  const [activeFeature, setActiveFeature] = useState(0);

const features = [
  {
    title: "Seamless Business Journey",
    description:
      "Landing pages are supposed to provide visitors with the exact information they require. That's what we offer. We also ensure that all our landing pages link with related pages without issue.",
    offers: [
      "Smooth navigation linking all relevant pages",
      "Optimized user journey to enhance conversions",
    ],
    icon: MapPin,
    color: "indigo",
  },
  {
    ...
    description:
      "Our entire content on landing pages is SEO optimized. So, rest assured, your landing page will be on top of the Google search results.",
    offers: [
      "Keyword-focused content to boost search rankings",
      "On-page SEO to increase organic traffic",
    ],
    icon: TrendingUp,
    color: "indigo",
  },
  {
    title: "Enticing Content",
    description:
      "Apart from exciting deals and offers that you add on the landing pages, we will also ensure that the content entices your audience with effective CTAs.",
    offers: [
      "Persuasive copywriting with clear CTAs",
      "Content designed to engage and convert visitors",
    ],
    icon: Zap,
    color: "indigo",
  },
  {
    title: "Representing your business",
    description:
      "Your business's logo will represent your business and set you apart. So, you need a logo that effectively conveys your message. It will also ensure that your message reaches your consumers and encourage them to do business with you.",
    offers: [
      "Consistent branding across your landing page",
  ...
  const buttonLabels = [
    "Creating a Seamless Business Journey",
...
export default LandingPageProposals;
