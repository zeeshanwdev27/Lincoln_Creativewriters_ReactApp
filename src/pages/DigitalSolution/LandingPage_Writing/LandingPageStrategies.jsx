...
import { Sparkles, Eye , FileText , BarChart2    } from "lucide-react";
import { motion } from "framer-motion";

function LandingPageStrategies() {

  const cardsData = [
    {
      icon: <Eye  className="w-8 h-8" />,
      title: "A better marketing campaign",
      description:
        "Our landing pages give your marketing campaign the leverage to succeed in the market. Your landing page can maximize results manifold with effective content and results-driven SEO strategies.",
      color: "from-blue-500 to-cyan-500",
    },
    {
      icon: <FileText  className="w-8 h-8" />,
      title: "Robust content section",
      description:
        "Our landing pages not only have exciting content, but they will help you engage your visitors when they land on your page and increase the chances of conversions through effective call-to-action.",
      color: "from-green-500 to-emerald-500",
    },
    {
      icon: <BarChart2 className="w-8 h-8" />,
      title: "A page with the highest results",
      description:
        "At Lincoln Creative Writers, we help businesses make the most out of the quick situation by creating landing pages that produce high-end results with visuals and content that improves user experience.",
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-7xl mx-auto">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-gray-900 mb-5">
          ...
          <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
            Landing page writers
          </span>
        </h1>

        <p className="text-sm md:text-md lg:text-lg text-gray-600 max-w-5xl mx-auto">
         Landing pages are an essential tool to help online businesses win the competition in the market. With our landing page content writers by your side, we can determine your business's goals and write content that converts for your business.
        </p>
      </div>
