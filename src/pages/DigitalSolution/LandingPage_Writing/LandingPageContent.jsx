...
const dummyData = [
  {
    image: "/DigitalSolution/LandingPage/content1.png",
    title: "Lead Generation Landing Pages Writing Service",
    description:
      "High-converting landing pages designed to capture leads and grow your email list or customer base with persuasive, targeted copy.",
    features: [
      "Engaging headlines and compelling CTAs",
      "Optimized for lead capture and conversions",
      "Tailored content for your target audience",
    ],
  },
  {
    image: "/DigitalSolution/LandingPage/content2.png",
    title: "Click Through Landing Page Writers",
    description:
      "Landing pages crafted to encourage users to click through to your offers, products, or services with clear, persuasive messaging.",
    features: [
      "Strong call-to-action elements",
      "Focused on driving user clicks",
      "Strategic layout to guide user behavior",
    ],
  },
  {
    image: "/DigitalSolution/LandingPage/content3.png",
    title: "Squeeze Landing Page Writers",
    description:
      "Optimized squeeze pages that effectively collect emails or small amounts of user information to build your marketing funnel.",
    features: [
      "Compact and highly persuasive copy",
      "Designed for maximum lead capture",
      "Minimal distractions for better focus on conversions",
    ],
  },
];
    ...
    >
      ...
      >
        ...
        >
         ...
         Hire Professional Landing page Writing Service
        </motion.div>
        ...
        <h1 className="text-4xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-4">
          Effective Landing page Writing Service
        </h1>
      </motion.div>
