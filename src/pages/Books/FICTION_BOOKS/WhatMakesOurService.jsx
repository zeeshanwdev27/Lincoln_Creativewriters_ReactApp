...
function WhatMakesOurService() {
  const [activeFeature, setActiveFeature] = useState(0);

  const features = [
    {
      title: "Thorough Project Study",
      description:
        "We at Lincoln Creative Writers conduct detailed research and study each project before starting, ensuring accuracy and authenticity in every story.",
      offers: [
        "Customized content for every genre",
        "Deep understanding of client vision",
    ...
    },
    {
      ...
      description:
        "Our creative writers bring innovative ideas to the table, collaborating closely with clients to make stories engaging and impactful.",
      offers: [
    ...
    },
    {
      ...
      description:
        "We craft original, compelling stories that captivate readers from start to finish, combining creativity with meticulous attention to detail.",
      offers: [
        "Unique storytelling style",
        "Engaging narratives for all readers",
    ...
    },
    {
      ...
      description:
        "We provide unlimited revisions to ensure the final manuscript aligns perfectly with the client’s vision.",
      offers: [
        "Collaborative writing process",
        "Adjustments until satisfaction",
    ...
    },
    {
      ...
      description:
        "Our team offers dedicated support to guide clients through the writing process, answering questions and providing timely feedback.",
      offers: [
    ...
    },
    {
      ...
      description:
        "We provide professional guidance at every stage of book creation, from idea development to final manuscript refinement.",
      offers: [
        "Manuscript development advice",
        "Outline and structure guidance",
        "Expert tips for successful publishing",
      ],
      icon: UserCheck,
      color: "indigo",
    },
    ...
    <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-25 py-12 lg:py-15 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          >
            Hire Professional Fiction Book Writers Now
          </motion.p>
          ...
          >
            What Makes Our Services Stand Apart From Competition?
          </motion.h1>
...
export default WhatMakesOurService;
